...
async def test_repro_issue_119_differentiation(store, mock_hass):
    ...
    p30_data = []
    for i in range(0, 1200, 60): p30_data.append([(start_ts_30 + timedelta(seconds=i)).isoformat(), 100.0])
    for i in range(1200, 1800, 60): p30_data.append([(start_ts_30 + timedelta(seconds=i)).isoformat(), 2000.0])
    for i in range(1800, 3000, 60): p30_data.append([(start_ts_30 + timedelta(seconds=i)).isoformat(), 200.0])
