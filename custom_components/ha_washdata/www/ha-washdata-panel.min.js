...
`));b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.both_agree",{},"WashData recommends"))}</span><span class="wd-sug-val">${d(_)}${n}</span>${x(_)}${F}</div>`}else{const I=S?ct(S):"",F=k?ct(k):"",z=g("suggestion.observed_label",{},"Observed"),R=g("suggestion.calibrated_label",{},"Calibrated");let P="",A="";if(!isNaN(v)&&!isNaN(T)){const G=T>v;A=g(`suggestion.impact.${s}.${G?"higher":"lower"}`,{},""),P=g(`suggestion.impact.${s}.${G?"lower":"higher"}`,{},"")}const M=P?`<div class="wd-sug-impact-line">${d(P)}</div>`:"",O=A?`<div class="wd-sug-impact-line">${d(A)}</div>`:"";b=`<div class="wd-sug wd-sug-split"><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(z)}</span><span class="wd-sug-val">${d(_)}${n}</span>${x(_)}${I}${M}</div><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(R)}</span><span class="wd-sug-val">${d(u)}${n}</span>${x(u)}${F}${O}</div></div>`}}else if(_!=null){const v=S?ct(S):"",T=t!=null&&t!==""?` <span style="opacity:.6;font-size:.9em">(now ${d(t)}${n})</span>`:"";b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.observed_label",{},"Observed"))}</span><span class="wd-sug-val">${d(_)}${n}</span>${T}${x(_)}${v}</div>`}else if(u!=null){const v=k?ct(k):"";b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(g("suggestion.calibrated_label",{},"Calibrated"))}</span><span class="wd-sug-val">${d(u)}${n}</span>${x(u)}${v}</div>`}if(b&&s){const v=d(g("btn.mute_suggestion",{},"Stop suggesting this setting")),T=`<button type="button" class="wd-sug-lock" data-suglock="${s}" title="${v}" aria-label="${v}">\u{1F515}</button>`;b=b.replace(/<\/div>\s*$/,T+"</div>")}return`<div class="wd-field" data-field="${s}"><div class="wd-label-row"><label style="margin:0">${d(r)}</label>${o}${a}</div>${i}${h.hint?`<div class="wd-field-hint">${d(h.hint)}</div>`:""}<div class="wd-conflict-err" data-cerr="${s}" hidden></div>${b}</div>`}function qt(h,t){if(h==null||t==null)return!1;const e=parseFloat(h),s=parseFloat(t);return!isNaN(e)&&!isNaN(s)?Math.abs(e-s)<1e-6:String(h)===String(t)}const xe={min_power:"min_power",off_delay:"off_delay",smoothing_window:"smoothing",start_threshold_w:"hysteresis",stop_threshold_w:"hysteresis",start_energy_threshold:"start_energy",running_dead_zone:"dead_zone",profile_duration_tolerance:"duration_tolerance",profile_match_min_duration_ratio:"match_ratios",profile_match_max_duration_ratio:"match_ratios",progress_reset_delay:"progress_reset",completion_min_seconds:"min_duration",min_off_gap:"min_off_gap",start_duration_threshold:"start_duration",end_energy_threshold:"end_energy_thresh",end_repeat_count:"end_repeat",profile_match_threshold:"confidence",profile_unmatch_threshold:"confidence",auto_label_confidence:"confidence",learning_confidence:"confidence",no_update_active_timeout:"watchdog_timeout",anti_wrinkle_enabled:"anti_wrinkle",anti_wrinkle_max_power:"anti_wrinkle",anti_wrinkle_max_duration:"anti_wrinkle",anti_wrinkle_exit_power:"anti_wrinkle",anti_wrinkle_idle_timeout:"anti_wrinkle",anti_crease_finalize_ratio:"anti_wrinkle",sampling_interval:"sampling"};function le(h){let t=0,e=window.innerWidth,s=0,r=window.innerHeight;for(let n=h.parentElement;n;n=n.parentElement){const a=getComputedStyle(n),o=a.overflowX!=="visible",i=a.overflowY!=="visible";if(!o&&!i)continue;const l=n.getBoundingClientRect();o&&(l.left>t&&(t=l.left),l.right<e&&(e=l.right)),i&&(l.top>s&&(s=l.top),l.bottom<r&&(r=l.bottom))}return{left:t,right:e,top:s,bottom:r}}function ct(h,t){return`<span class="wd-tip">i<span class="wd-tip-pop">${t?$e(t):""}<span class="wd-tip-txt">${d(h)}</span></span></span>`}function Vt(h,t,e=""){return`<label class="wd-switch-lbl"><span class="wd-switch"><input type="checkbox" ${h}><span class="wd-switch-slider"></span></span><span class="wd-switch-text wd-switch-text--plain">${d(t)}</span></label>${e||""}`}function Mt(h,t,e="",s=""){return`<div class="wd-field wd-field-switch"><div class="wd-switch-row">${Vt(h,t,e)}</div>${s?`<div class="wd-field-hint">${d(s)}</div>`:""}</div>`}function $e(h){const t=s=>`<svg class="wd-dg" viewBox="0 0 200 90" preserveAspectRatio="xMidYMid meet">${s}</svg>`,e='<line class="ax" x1="8" y1="78" x2="192" y2="78"/>';switch(h){case"smoothing":return t(`${e}
    ...
    `}_htmlSetupCard(t,e=!1){if(!t)return"";const{phase:s,message_key:r,message_params:n,cta_label_key:a,cta_action:o,secondary_label_key:i,secondary_action:l,skippable:c,dismissible:p,step_key:_}=t;if(s==="phase4")return`
        ...
        </div>`;const u=this._t(r,n||{},""),g=this._t(a,{},"Continue"),S=i?this._t(i,{},""):null,k=c?`
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap">
    ...
    </div>`}_htmlHistory(){const t=this._cycles||[],e=this._refCycles||[],s=e.concat(t),r=this._canEdit(),n=this._selectMode&&r,a=this._cycleSel,{col:o,dir:i}=this._cycleSort,{text:l,status:c}=this._cycleFilter,p=this._mlById||{},_=new Set((this._feedbacks||[]).map(w=>w.cycle_id)),u=w=>p[w.id],g=w=>{const C=u(w);return!!(C&&C.ml_review&&C.ml_review.reviewed_at)},S=w=>{const C=u(w);return!!(C&&C.ml_review&&C.ml_review.golden)},k=w=>{if(_.has(w.id))return!0;if(g(w))return!1;const C=u(w),Y=C&&C.ml_quality_label;return["uncertain","review"].includes(Y)||["force_stopped","interrupted"].includes(w.status)},x=s.filter(k).length;let b=s;if(l){const w=l.toLowerCase();b=b.filter(C=>(C.profile_name||C.matched_profile||"").toLowerCase().includes(w))}c==="unlabelled"?b=b.filter(w=>!w.profile_name&&!w.matched_profile):c==="needs_review"?b=b.filter(k):c==="imported"?b=b.filter(w=>w.is_reference):c&&(b=b.filter(w=>(w.status||"completed")===c));const v={date:w=>w.start_time?new Date(w.start_time).getTime():0,confidence:w=>w.match_confidence,duration:w=>w.duration,energy:w=>w.energy_kwh!=null?w.energy_kwh:w.energy_wh!=null?w.energy_wh/1e3:null,cost:w=>w.cost!=null?w.cost:-1,status:w=>w.status||"completed",profile:w=>(w.profile_name||w.matched_profile||"\uFFFF").toLowerCase()};b=ie(b,v[o]||v.date,i);const T=w=>w==="completed"?"var(--success-color, #4caf50)":w==="interrupted"?"var(--error-color, #f44336)":w==="force_stopped"?"var(--warning-color, #ff9800)":"var(--secondary-text-color)",L=w=>{if(!w.is_reference)return"";const C=w.cycle_origin==="backfill",Y=C?this._t("badge.backfilled_tip",{},"Detected in imported power history. Shapes program matching only, not counted in stats."):this._t("badge.imported_tip",{},"Imported from the community store. Used for matching only, not counted in stats.");return` <span title="${d(Y)}" style="color:var(--info-color,#2196f3)">${C?"\u{1F557}":"\u{1F4E5}"}</span>`},I=w=>S(w)?' <span title="'+d(this._t("badge.golden_cycle",{},"Recorded reference cycle"))+'" style="color:var(--warning-color,#ff9800)">\u2B50</span>':_.has(w.id)?' <span title="'+d(this._t("badge.feedback_requested",{},"Feedback requested"))+'" style="color:var(--info-color,#2196f3)">\u{1F4AC}</span>':g(w)?' <span title="'+d(this._t("badge.reviewed",{},"Reviewed"))+'" style="color:var(--success-color,#4caf50)">\u2713</span>':k(w)?' <span title="'+d(this._t("badge.needs_review",{},"Needs review"))+'" style="color:var(--error-color,#f44336)">\u25CF</span>':"",F=w=>{if(w.anomaly!=="overrun")return"";const C=w.overrun_ratio?" "+this._t("badge.overrun_ratio",{x:Number(w.overrun_ratio).toFixed(1)},`(${Number(w.overrun_ratio).toFixed(1)}x expected)`):"";return` <span title="${d(this._t("badge.overrun",{},"Ran longer than usual"))}${d(C)}" style="color:var(--warning-color,#ff9800)">\u23F1</span>`},z=w=>{if(w.anomaly!=="underrun")return"";const C=w.underrun_ratio?" "+this._t("badge.underrun_ratio",{pct:Math.round(w.underrun_ratio*100)},`(${Math.round(w.underrun_ratio*100)}% of expected)`):"";return` <span title="${d(this._t("badge.underrun",{},"Finished faster than usual"))}${d(C)}" style="color:var(--info-color,#2196f3)">\u26A1</span>`},R=w=>{if(!w.energy_anomaly||w.energy_anomaly==="none")return"";const C=w.energy_anomaly==="energy_spike",Y=w.energy_z_score!=null?` (${w.energy_z_score>0?"+":""}${Number(w.energy_z_score).toFixed(1)}\u03C3)`:"",N=C?"badge.energy_spike":"badge.energy_low",V=C?"Higher energy than usual":"Lower energy than usual",H=C?"\u{1F53A}":"\u{1F53B}",W=C?"var(--error-color,#f44336)":"var(--info-color,#2196f3)";return` <span title="${d(this._t(N,{},V))}${d(Y)}" style="color:${W}">${H}</span>`},P=w=>{const C=Array.isArray(w.artifacts)?w.artifacts.length:0;return C?` <span title="${d(this._t("badge.artifact_tip",{n:C},`${C} anomal${C>1?"ies":"y"} detected (e.g. door opened mid-cycle) \u2014 open to see them on the graph`))}" style="color:var(--warning-color,#ff9800)">\u26A0</span>`:""},A=w=>{const C=Array.isArray(w.restart_gaps)?w.restart_gaps.length:0;return C?` <span title="${d(this._t("badge.restart_gap_tip",{n:C},`${C} HA restart gap${C>1?"s":""} during this cycle \u2014 power trace has a hole`))}" style="color:var(--info-color,#2196f3)">\u21BB</span>`:""},M=this._hass&&this._hass.config&&this._hass.config.currency||"",O=w=>{if(w.cost==null)return"-";const C=`${w.cost.toFixed(2)}${M?" "+M:""}`;if(w.energy_price_mode==="dynamic"&&w.energy_price!=null){const Y=this._t("col.cost_dynamic_tip",{price:w.energy_price.toFixed(4),cur:M},`Time-weighted: charged at the price in force during the cycle (effective ${w.energy_price.toFixed(4)} ${M}/kWh).`);return`<span title="${d(Y)}" style="border-bottom:1px dotted var(--secondary-text-color)">${C}</span>`}return C},G=b.map(w=>{const C=w.profile_name||w.matched_profile,Y=w.match_confidence!=null?w.match_confidence*100:null,N=w.status||"completed",V=w.energy_kwh!=null?w.energy_kwh:w.energy_wh!=null?w.energy_wh/1e3:null,H=n,W=H?`<input type="checkbox" class="wd-csel" ${a.has(w.id)?"checked":""} style="width:auto;margin:0">`:`<span class="wd-devdot" style="background:${T(N)}" title="${d(N)}"></span>`,D={completed:this._t("status.completed",{},"Completed"),interrupted:this._t("status.interrupted",{},"Interrupted"),force_stopped:this._t("status.force_stopped",{},"Force stopped"),active:this._t("status.active",{},"Active")}[N]||N,j=`${L(w)}${I(w)}${F(w)}${z(w)}${R(w)}${P(w)}${A(w)}`.trim();return`<tr data-cid="${d(w.id)}" data-selmode="${H?1:0}" style="cursor:pointer">
        <td style="width:26px;padding:6px 4px 6px 8px">${W}</td>
        <td>${C?d(C):`<span style="color:var(--secondary-text-color)">${this._t("lbl.unlabelled",{},"Unlabelled")}</span>`}</td>
        <td class="wd-tc-flags">${j}</td>
        ...
        <td class="wd-tc-num">${Y!=null?Y.toFixed(0)+"%":"-"}</td>
      </tr>`}).join(""),et=`<thead><tr>
    ...
    </div>`,X=b.length!==s.length?this._t("lbl.n_shown",{n:b.length},`, ${b.length} shown`):"",Q=e.length?this._t("lbl.n_imported_note",{n:e.length},`, ${e.length} imported`):"",wt=this._t("lbl.cycles_title",{n:`${t.length}${Q}${X}`},`Cycles (${t.length}${Q}${X})`),q=r?`<div class="wd-card-actions" style="margin:0 0 4px;justify-content:flex-end">
    ...
    </div>`:"",ht=new Set(e.map(w=>w.id)),Z=[...a].some(w=>ht.has(w)),at=n?`<div class="wd-card-actions" style="margin:0 0 10px">
    ...
    `}_htmlProfileGroupModal(t){const e=this._busy.has("pg-save"),s=this._profileEnvCache||{},r=_=>it[Math.max(0,this._profiles.findIndex(u=>u.name===_))%it.length],n=t.members||[],a=this._profiles.map(_=>{const u=n.includes(_.name),g=_.avg_duration?`~${Math.round(_.avg_duration/60)}m`:"",S=_.avg_energy!=null?` \xB7 ${yt(_.avg_energy)}`:"",k=u?`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${r(_.name)};margin:0 2px"></span>`:"";return`<label class="wd-rev-tag"><input type="checkbox" class="wd-pg-mem" value="${d(_.name)}" ${u?"checked":""}> ${k}${d(_.name)} <span style="color:var(--secondary-text-color);font-size:.85em">${g}${S}</span></label>`}).join(""),o=n.filter(_=>s[_]&&(s[_].avg||[]).length),i=o.length?`<div class="wd-leg">${o.map(_=>`<span class="wd-leg-i"><span class="wd-leg-sw" style="background:${r(_)}"></span> ${d(_)}</span>`).join("")}</div>`:"",l=o.length?`<div class="wd-canvas-wrap" style="margin-top:8px"><canvas id="wd-pgroup-canvas" role="img" aria-label="${d(this._t("lbl.aria_envelope_chart",{},"Profile power envelope chart"))}" style="height:150px"></canvas></div>${i}`:`<p class="wd-info">${this._t("msg.group_preview_hint",{},"Tick 2+ members to preview and compare their power curves.")}</p>`,c=((this._profileGroups||{}).groups||[]).find(_=>_.name===t.orig),p=c&&c.cohesion!=null?`<span class="wd-badge" style="color:${c.cohesive?"var(--success-color,#4caf50)":"var(--warning-color,#ff9800)"};background:${c.cohesive?"rgba(76,175,80,.14)":"rgba(255,152,0,.14)"}">${c.cohesive?this._t("lbl.cohesion_good",{pct:Math.round(c.cohesion*100)},"cohesion "+Math.round(c.cohesion*100)+"%"):this._t("lbl.cohesion_low",{pct:Math.round(c.cohesion*100)},"\u26A0 low cohesion "+Math.round(c.cohesion*100)+"%")}</span>`:"";return`<h2>${t.orig?this._t("modal.edit_group",{},"Edit profile group"):this._t("modal.new_group",{},"New profile group")}</h2>
    ...
    </label>`,k=r?`<p class="wd-info" style="margin:0 0 10px;font-size:.82em">${this._t("msg.settings_basic_note",{},"Showing essential settings. Switch to Advanced for the full list.")}</p>`:"",x=this._busy.has("save-settings"),b=l.size,v=b!==1?"s":"",T=b?`
      ...
      </div>`:"",L=this._suggestions.length,I=[...a].filter(q=>!n.has(q)).length,F=L+I,z=this._settingsSugOnly&&!this._settingsSearch,R=L?`<button class="wd-btn wd-btn-sm wd-btn-primary" data-action="sug-apply-all">${this._t("btn.apply_all",{},"Apply all")}</button>`:"",P=L?`<button class="wd-btn wd-btn-sm wd-btn-secondary" data-action="sug-dismiss">${this._t("btn.dismiss",{},"Dismiss")}</button>`:"",A=F?z?`
    ...
    `}_htmlSettingsHistory(){const t=this._settingsChangelog||[];if(!t.length)return"";const e=this._settingsHistoryOpen,s=this._canEdit(),r=t.slice(0,100).map(n=>{const a=s?`<button class="wd-btn wd-btn-secondary wd-btn-xs" data-action="settings-revert-key" data-key="${d(n.key)}" data-val="${d(JSON.stringify(n.old))}" title="${d(this._t("btn.revert_to_previous",{},"Restore this setting to its previous value"))}">${this._t("btn.revert",{},"Revert")}</button>`:"";return`<tr>
        ...
        <td class="wd-tc-date">${ot(n.timestamp)}</td>
    ...
    `}_htmlMlStatusSection(t,e){const s=e&&this._busy.has("ml-train-now:"+e)||t&&t.running,r=this._canEdit()?`<button class="wd-btn wd-btn-primary wd-btn-sm" data-action="ml-train-now" ${s?"disabled":""}>${s?`<span class="wd-spin"></span> ${this._t("status.training",{},"Training\u2026")}`:this._t("btn.train_now",{},"Train now")}</button>`:"";if(!t)return`<div class="wd-card"><div class="wd-card-title" style="margin:0 0 4px">${this._t("hdr.status",{},"Status")}</div><p class="wd-info" style="margin:0">${this._t("msg.loading",{},"Loading\u2026")}</p></div>`;const n=Object.keys(t.on_device_models||{}).length,a=n?`<span style="color:var(--success-color,#4caf50);font-weight:600">${this._t("ml.personalized",{},"\u25CF Personalized to this machine")}</span> <span style="color:var(--secondary-text-color)">${this._t("lbl.models_fine_tuned",{count:n},"(fine-tuned models: "+n+")")}</span>`:`<span style="color:var(--secondary-text-color)">${this._t("ml.builtin_models",{},"\u25CF Using built-in models")}</span>`,o=t.cycle_count||0,i=t.min_cycles||0,l=o>=i,c=i>0?Math.min(100,Math.round(o/i*100)):100,p=l?"var(--success-color,#4caf50)":"var(--warning-color,#ff9800)",_=Math.max(0,i-o),u=l?this._t("msg.enough_data",{current:o,min:i},`Enough data to learn from (${o}/${i} cycles).`):this._t("msg.collecting_data",{need:_,current:o,min:i},`Collecting data. Cycles still needed before fine-tuning can start: ${_} (${o}/${i}).`),g=`<div style="height:8px;border-radius:6px;background:var(--secondary-background-color);overflow:hidden;margin:8px 0"><div style="width:${c}%;height:100%;background:${p}"></div></div>`,S=t.last_trained?ot(t.last_trained):"never",k=s?`<span style="color:var(--info-color,#2196f3)"><span class="wd-spin"></span> ${this._t("status.fine_tuning",{},"fine-tuning now\u2026")}</span>`:t.enabled?this._t("lbl.auto_fine_tune_on",{hour:String(t.hour).padStart(2,"0")},`auto fine-tune on (around ${String(t.hour).padStart(2,"0")}:00)`):this._t("lbl.auto_fine_tune_off",{},"auto fine-tune off");return`<div class="wd-card">
      ...
      ${r}
        ...
        </div>`,n=k);const A=this._pgStagedVal(_),M=A!=null&&!(v!==""&&v!==null&&v!==void 0&&this._pgSameVal(A,v)),O=this._canEdit()&&M&&this._pgIsPublishable(_)?`<button class="wd-pg-pub" data-action="pg-publish-one" data-pgkey="${d(_)}" aria-label="${d(this._t("btn.pg_publish_one",{label:b},"Publish "+b+" to the integration"))}" title="${d(this._t("btn.pg_publish_one",{label:b},"Publish "+b+" to the integration"))}">\u2191</button>`:'<span class="wd-pg-pub-slot" aria-hidden="true"></span>';return`${P}<div style="display:flex;align-items:flex-start;gap:6px;margin:0 0 6px 11px">
        <div style="flex:1;min-width:0">
          <div style="font-size:.82em;font-weight:600;margin-bottom:1px">${d(b)}${I?` <span style="color:${z};font-size:.85em" title="${d(this._t("lbl.pg_drag_hint",{},"Drag line on graph"))}">\u2195</span>`:""}</div>
          ${S?`<div style="font-size:.72em;color:var(--secondary-text-color);line-height:1.3">${d(this._t("pg_desc."+_,{},S))}</div>`:""}
        </div>
        <div style="display:flex;align-items:center;gap:4px;flex-shrink:0">
          ${L?`<input class="wd-pg-param-chk" type="checkbox" data-pgkey="${d(_)}" data-pgtype="bool" aria-label="${d(b)}" ${T?"checked":""} style="width:18px;height:18px;margin:1px 27px 0 27px">`:`<input class="wd-pg-param-inp" type="text" inputmode="decimal" data-pgkey="${d(_)}" value="${T!==""?d(String(T)):""}" placeholder="${v!==""?d(String(v)):""}" aria-label="${d(b)}" style="width:72px">`}
    ...
    </div>`:"",k=s.map(v=>{const T=parseInt(a[v],10)||0;if(T<=0)return"";const L=Math.max(0,parseInt(o[v],10)||0),I=Math.max(0,Math.min(100,Math.round(L/T*100))),z=L>=T?"var(--warning-color,#ff9800)":"var(--primary-color)";return`<div style="margin-top:10px">
        <div style="display:flex;align-items:baseline;justify-content:space-between;gap:8px">
          <span style="font-weight:600">${d(this._maintLabel(v))}</span>
          <span class="wd-info">${this._t("lbl.cycles_since_service",{since:L,total:T},L+" / "+T+" cycles")}</span>
        </div>
        <div style="height:6px;margin-top:4px;border-radius:3px;background:var(--divider-color);overflow:hidden">
          <div style="height:100%;border-radius:3px;width:${I}%;background:${z}"></div>
        </div>
    ...
    ${r||`<div class="wd-card"><p class="wd-info">${this._t("msg.no_other_users",{},"No other Home Assistant users found.")}</p></div>`}`}_htmlStore(){if(!this._canEdit())return`<div class="wd-empty">${this._t("msg.no_device_selected",{},"No device selected.")}</div>`;const t=this._storeStatus,e=`<a href="https://3dg1luk43.github.io/washdata-store" target="_blank" rel="noopener noreferrer" style="font-size:.8em;font-weight:400;color:var(--primary-color);text-decoration:none;white-space:nowrap" title="${d(this._t("store.website_tip",{},"Open the community store website"))}">${this._t("store.website",{},"Store website \u2197")}</a>`,s=`<div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap"><div class="wd-card-title" style="margin:0">${this._t("hdr.community_store",{},"Community Store")}</div>${e}</div>`;if(!this._onlineEnabled()||t&&t.enabled===!1)return`<div class="wd-card">${s}
      ...
      <div class="wd-log-drawer-body">
        ...
        <div class="wd-modal-actions"><button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.cancel",{},"Cancel")}</button>
        <button class="wd-btn wd-btn-primary" data-maction="label-ok">${this._t("btn.apply_label",{},"Apply Label")}</button></div>`;else if(t.type==="create-profile"){const s=(this._cycles||[]).slice(0,40).map(r=>`<option value="${d(r.id)}">${ot(r.start_time)} - ${Math.round((r.duration||0)/60)}m - ${d(r.profile_name||this._t("lbl.unlabelled",{},"Unlabelled"))}</option>`).join("");e=`<h2>${this._t("modal.create_profile",{},"Create Profile")}</h2>
        ...
        <button class="wd-btn wd-btn-primary" data-maction="store-share-ok" ${this._busy.has("store-share")?"disabled":""}>${this._busy.has("store-share")?'<span class="wd-spin"></span> ':""}${this._t("btn.share",{},"Share")}</button></div>`}else t.type==="store-share-device"&&(e=this._htmlShareDeviceModal(t));return`<div class="wd-overlay"><div class="wd-modal" role="dialog" aria-modal="true" aria-labelledby="wd-modal-title" tabindex="-1">${e}</div></div>`}_htmlShareDeviceModal(t){const e=this._shareableByProgram(),s=this._busy.has("store-share-device"),r=t.selected||new Set,n=!!t.consented,a=e.reduce((g,S)=>g+S.cycles.filter(k=>r.has(k.id)).length,0),o=e.some(g=>!g.noCycles);let i;t.loading?i=`<div class="wd-empty" style="padding:24px"><div class="wd-icon">\u23F3</div>${this._t("msg.loading",{},"Loading\u2026")}</div>`:e.length?i=e.map(g=>{if(g.noCycles)return`<div class="wd-sd-group wd-sd-group-nocyc">
          ...
          </div>`;const S=g.cycles.every(T=>r.has(T.id)),k=!S&&g.cycles.some(T=>r.has(T.id)),x=g.cycles.map(T=>{const L=T.start_time?ot(T.start_time):"",I=T.duration!=null?_t(T.duration):"";return`<label class="wd-sd-cyc">
            <input type="checkbox" data-maction="sd-toggle-cyc" data-cid="${d(T.id)}" ${r.has(T.id)?"checked":""} ${s?"disabled":""}>
            <span class="wd-sd-cyc-meta">${d(L)} \xB7 ${d(I)} \u2B50</span>
      ...
      <span class="wd-sd-prof-name"><strong>${this._t("btn.select_all",{},"Select all")}</strong></span>
    </label>`,c=a.map(p=>{const _=r[p],u=s.importableOnly&&_.importable===!1,g=this._wizCatState(t,p,e),k=["profiles","real_cycles","reference_cycles"].includes(p)?`${g.sel}/${_.count}`:"",x=`<label class="wd-sd-prof">
          ...
          <span class="wd-sd-cyc-meta">${d(v.name)} \xB7 ${(v.real_cycles||0)+(v.reference_cycles||0)} ${this._t("lbl.cycles_short",{},"cycles")}${n.has(v.name)?` <span class="wd-tag" style="color:var(--warning-color,#e6a700)">${this._t("badge.exists",{},"exists")}</span>`:""}</span>
        </label>`).join("")}</div>`;else if(!u&&(p==="real_cycles"||p==="reference_cycles")){const v=p==="real_cycles"?t.sel.realIds:t.sel.refIds;b=`<div class="wd-sd-cycles">${(_.groups||[]).map(T=>{const L=T.cycles.map(M=>String(M.id)),I=L.filter(M=>v.has(M)).length,F=I===L.length&&L.length>0,z=I>0&&!F,R=`${p}:${T.profile}`,P=t.expanded&&t.expanded.has(R),A=P?T.cycles.map(M=>`<label class="wd-sd-cyc" style="margin-left:18px">
            ...
            <div class="wd-sd-cyc" style="display:flex;align-items:center">
              <label style="flex:1;display:flex;align-items:center;gap:8px;cursor:pointer">
                ...
                <span class="wd-sd-cyc-meta"><strong>${d(T.profile||this._t("lbl.unlabelled",{},"Unlabelled"))}</strong> (${I}/${T.count})</span>
              </label>
    ...
    </div>`;let u="";const S=(r.categories&&r.categories.profiles&&r.categories.profiles.items||[]).filter(x=>x.conflict&&t.sel.profiles.has(x.name));t.mode==="merge"&&S.length&&(u=`<div class="wd-field"><label>${this._t("lbl.conflict_resolution",{},"Name clashes")}</label>
      ...
      <div class="wd-modal-actions">
        ...
        <div class="wd-field">
          ...
          <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
            ...
            <input type="date" id="wd-hist-since" value="${d(t.since||Wt())}" min="${d(ye())}" max="${d(me())}" ${b}>
        ...
        </div>`;const S=n.map(x=>{const b=i.has(x.index),v=this._histSegReason(x.reason);return`<tr data-hist-row="${x.index}" style="${b?"":"opacity:.55"}">
      ...
      <button class="wd-btn wd-btn-sm ${t.mode==="review"?"wd-btn-primary":"wd-btn-secondary"}" data-maction="cyc-review" title="${S?this._t("hdr.automation_needs_review",{},"This cycle needs review"):this._t("hdr.automation_review_this_cycle",{},"Review this cycle")}">${this._t("btn.review",{},"Review")}${k}</button>
        ...
        </div>`}else if(t.mode==="review"){const A=l&&l.ml_review||{},M=this._busy.has("cyc-review-save"),O=(Z,at)=>`<option value="${Z}" ${(A.quality||"")===Z?"selected":""}>${at}</option>`,et=[["late_start",this._t("tag.late_start",{},"Late start")],["early_end",this._t("tag.early_end",{},"Early end")],["merged",this._t("tag.merged",{},"Merged cycles")],["split",this._t("tag.split",{},"Split cycle")],["noise",this._t("tag.noise",{},"Noise")],["wrong_profile",this._t("tag.wrong_profile",{},"Wrong profile")],["sensor_gap",this._t("tag.sensor_gap",{},"Sensor gap")]].map(([Z,at])=>`<label class="wd-rev-tag"><input type="checkbox" class="wd-cyc-rev-tag" value="${Z}" ${(A.tags||[]).includes(Z)?"checked":""}> ${at}</label>`).join(""),st=A.reviewed_at?`<span style="font-size:.75em;color:var(--secondary-text-color)">${this._t("lbl.reviewed_on",{date:new Date(A.reviewed_at).toLocaleDateString()},`reviewed ${new Date(A.reviewed_at).toLocaleDateString()}`)}</span>`:"",X=ct(this._t("msg.review_profile_tip",{},"The program this cycle is labelled as. If the auto-detected program was wrong, correct it here - labelling teaches matching for future cycles.")),Q=ct(this._t("msg.review_quality_tip",{},"How clean this cycle is. Good = a textbook example of this program; Bad = detected but noisy or atypical; Unusable = mis-detected (merged, truncated or spurious). Drives the health score and which cycles are allowed to train the model.")),wt=ct(this._t("msg.review_recorded_tip",{},'Mark this as a hand-picked reference cycle for its program - the same role as a manually recorded cycle. Reference cycles are always kept, seed the matching template, and are never dropped by cleanup. (This is the "golden"/recorded flag; both are the same thing.)')),q=ct(this._t("msg.review_tags_tip",{},"Optional flags describing what went wrong with this cycle, so training and cleanup can account for it.")),ht=ct(this._t("msg.review_notes_tip",{},"Free-text notes for your own reference. Not used by matching or training."));L=`
        ${T}
        ...
        <div class="wd-rev-tags">${(this._profiles||[]).map(Z=>{const at=(t.overlays||[]).includes(Z.name),pt=at?`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${it[Math.max(0,this._profiles.findIndex(m=>m.name===Z.name))%it.length]};margin:0 2px"></span>`:"";return`<label class="wd-rev-tag"><input type="checkbox" class="wd-cyc-overlay" value="${d(Z.name)}" ${at?"checked":""}> ${pt}${d(Z.name)}</label>`}).join("")||`<span class="wd-info">${this._t("msg.no_profiles_compare",{},"No profiles to compare.")}</span>`}</div>
        ...
        </div>`}let I="";const F=t.mode==="view"||t.mode==="review"?e.artifacts||[]:[];if(F.length){const A=F.map(M=>{const O=M.detail_key?this._t(M.detail_key,M.detail_params||{},M.detail||""):M.detail||"";return`<li><b>${d(ae(M.type,(G,et,st)=>this._t(G,et,st)))}</b> ${this._t("lbl.at",{},"at")} ${zt(M.start_s)}\u2013${zt(M.end_s)} \u2014 ${d(O)}</li>`}).join("");I=`<div class="wd-card" style="margin:10px 0 0;padding:10px 12px;border-left:3px solid var(--warning-color,#ff9800)">
      ...
      ${I}
      ${z}
      ${L}`}_htmlProfilePanel(t){const e=this._canEdit();t.tab==="danger"&&!e&&(t.tab="stats");const s=[["stats",this._t("tab.pp_overview",{},"Overview")],["phases",this._t("tab.pp_phases",{},"Phases")],["cleanup",this._t("tab.pp_cleanup",{},"Cleanup")]];e&&s.push(["danger",this._t("tab.pp_manage",{},"Manage")]);const r=s.map(([o,i])=>`<button class="wd-mini-tab ${t.tab===o?"active":""}" data-maction="pp-tab-${o}">${i}</button>`).join("");let n="";if(!t.loaded)n=`<div class="wd-empty" style="padding:32px"><div class="wd-icon">\u23F3</div>${this._t("msg.loading",{},"Loading\u2026")}</div>`;else if(t.tab==="stats"){const o=t.stats||{},i=t.env||{},l=this._hass&&this._hass.config&&this._hass.config.currency||"",c=o.avg_energy!=null&&o.cycle_count?o.avg_energy*o.cycle_count:null,p=k=>k?Math.round(k/60)+"m":"-",_=(this._profileHealth||{})[t.name],u=(this._profileTrends||{})[t.name],g=_&&_.health_status!=="unknown"?(()=>{const k={healthy:["var(--success-color,#4caf50)","rgba(76,175,80,.12)"],fair:["var(--warning-color,#ff9800)","rgba(255,152,0,.12)"],poor:["var(--error-color,#f44336)","rgba(244,67,54,.12)"]},[x,b]=k[_.health_status]||k.fair,v=Math.round((_.health_score||0)*100),T=_.duration_cv!=null?` \xB7 ${this._t("stat.duration_cv",{pct:Math.round(_.duration_cv*100)},`duration CV ${Math.round(_.duration_cv*100)}%`)}`:"",L=_.confidence_mean!=null?` \xB7 ${this._t("stat.avg_confidence",{pct:Math.round(_.confidence_mean*100)},`avg confidence ${Math.round(_.confidence_mean*100)}%`)}`:"";return`<div style="margin:8px 0 4px;padding:8px 12px;border-radius:6px;background:${b};border:1px solid color-mix(in srgb, ${x} 13%, transparent);display:flex;align-items:center;gap:8px;flex-wrap:wrap">
          ...
          <span style="font-size:.85em;opacity:.8">${this._t("stat.score",{pct:v},`score ${v}%`)}${T}${L}</span>
        ...
        ${e?"<th></th>":""}
      </tr></thead>`,S=this._busy.has("pp-cleanup-del"),k=this._busy.has("pp-cleanup-unlabel"),x=S||k;n=`<p class="wd-info" style="margin-bottom:10px">${this._t("msg.cleanup_intro",{},"Every labelled cycle overlaid. Tick outliers, then unlabel them (kept in history, but no longer shaping this profile) or delete them outright.")}</p>
