...
`));b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.both_agree",{},"WashData recommends"))}</span><span class="wd-sug-val">${d(p)}${n}</span>${x(p)}${O}</div>`}else{const z=$?dt($):"",O=k?dt(k):"",R=g("suggestion.observed_label",{},"Observed"),L=g("suggestion.calibrated_label",{},"Calibrated");let A="",C="";if(!isNaN(v)&&!isNaN(S)){const U=S>v;C=g(`suggestion.impact.${s}.${U?"higher":"lower"}`,{},""),A=g(`suggestion.impact.${s}.${U?"lower":"higher"}`,{},"")}const P=A?`<div class="wd-sug-impact-line">${d(A)}</div>`:"",F=C?`<div class="wd-sug-impact-line">${d(C)}</div>`:"";b=`<div class="wd-sug wd-sug-split"><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(R)}</span><span class="wd-sug-val">${d(p)}${n}</span>${x(p)}${z}${P}</div><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(L)}</span><span class="wd-sug-val">${d(f)}${n}</span>${x(f)}${O}${F}</div></div>`}}else if(p!=null){const v=$?dt($):"",S=t!=null&&t!==""?` <span style="opacity:.6;font-size:.9em">(now ${d(t)}${n})</span>`:"";b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.observed_label",{},"Observed"))}</span><span class="wd-sug-val">${d(p)}${n}</span>${S}${x(p)}${v}</div>`}else if(f!=null){const v=k?dt(k):"";b=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(g("suggestion.calibrated_label",{},"Calibrated"))}</span><span class="wd-sug-val">${d(f)}${n}</span>${x(f)}${v}</div>`}if(b&&s){const v=d(g("btn.mute_suggestion",{},"Stop suggesting this setting")),S=`<button type="button" class="wd-sug-lock" data-suglock="${s}" title="${v}" aria-label="${v}">\u{1F515}</button>`;b=b.replace(/<\/div>\s*$/,S+"</div>")}return`<div class="wd-field" data-field="${s}"><div class="wd-label-row"><label style="margin:0">${d(r)}</label>${o}${a}</div>${i}${h.hint?`<div class="wd-field-hint">${d(h.hint)}</div>`:""}<div class="wd-conflict-err" data-cerr="${s}" hidden></div><div class="wd-setting-note" data-cnote="${s}" hidden></div>${b}</div>`}function Vt(h,t){if(h==null||t==null)return!1;const e=parseFloat(h),s=parseFloat(t);return!isNaN(e)&&!isNaN(s)?Math.abs(e-s)<1e-6:String(h)===String(t)}const Te={min_power:"min_power",off_delay:"off_delay",smoothing_window:"smoothing",start_threshold_w:"hysteresis",stop_threshold_w:"hysteresis",start_energy_threshold:"start_energy",running_dead_zone:"dead_zone",profile_duration_tolerance:"duration_tolerance",profile_match_min_duration_ratio:"match_ratios",profile_match_max_duration_ratio:"match_ratios",progress_reset_delay:"progress_reset",completion_min_seconds:"min_duration",min_off_gap:"min_off_gap",start_duration_threshold:"start_duration",end_energy_threshold:"end_energy_thresh",end_repeat_count:"end_repeat",profile_match_threshold:"confidence",profile_unmatch_threshold:"confidence",auto_label_confidence:"confidence",learning_confidence:"confidence",no_update_active_timeout:"watchdog_timeout",anti_wrinkle_enabled:"anti_wrinkle",anti_wrinkle_max_power:"anti_wrinkle",anti_wrinkle_max_duration:"anti_wrinkle",anti_wrinkle_exit_power:"anti_wrinkle",anti_wrinkle_idle_timeout:"anti_wrinkle",anti_crease_finalize_ratio:"anti_wrinkle",sampling_interval:"sampling"};function de(h){let t=0,e=window.innerWidth,s=0,r=window.innerHeight;for(let n=h.parentElement;n;n=n.parentElement){const a=getComputedStyle(n),o=a.overflowX!=="visible",i=a.overflowY!=="visible";if(!o&&!i)continue;const l=n.getBoundingClientRect();o&&(l.left>t&&(t=l.left),l.right<e&&(e=l.right)),i&&(l.top>s&&(s=l.top),l.bottom<r&&(r=l.bottom))}return{left:t,right:e,top:s,bottom:r}}function dt(h,t){return`<span class="wd-tip">i<span class="wd-tip-pop">${t?Ee(t):""}<span class="wd-tip-txt">${d(h)}</span></span></span>`}function Ut(h,t,e=""){return`<label class="wd-switch-lbl"><span class="wd-switch"><input type="checkbox" ${h}><span class="wd-switch-slider"></span></span><span class="wd-switch-text wd-switch-text--plain">${d(t)}</span></label>${e||""}`}function Mt(h,t,e="",s=""){return`<div class="wd-field wd-field-switch"><div class="wd-switch-row">${Ut(h,t,e)}</div>${s?`<div class="wd-field-hint">${d(s)}</div>`:""}</div>`}function Ee(h){const t=s=>`<svg class="wd-dg" viewBox="0 0 200 90" preserveAspectRatio="xMidYMid meet">${s}</svg>`,e='<line class="ax" x1="8" y1="78" x2="192" y2="78"/>';switch(h){case"smoothing":return t(`${e}
    ...
    `}_htmlDeviceBar(){const t=this._isAdmin()?`<button class="wd-devcard wd-devadd" data-action="add-device" title="${d(this._t("btn.add_device_tip",{},"Add another WashData device"))}">${this._t("btn.add_device",{},"+ Add device")}</button>`:"";return this._devices.length<=1?t?`<div class="wd-devbar">${t}</div>`:"":`<div class="wd-devbar">${this._devices.map((e,s)=>{const r=e.is_user_paused?"user_paused":e.detector_state||"unknown",n=Rt.includes(r),a=!!e.recording,o=a?"var(--error-color, #f44336)":this._stateColor(r),i=a?this._t("status.recording",{},"Recording"):this._stateLabel(r),l=[],c=this._conflictCountForOpts(e.options||{},e.option_defaults||{});c&&l.push(`<span class="wd-dbadge conf">\u26A0 ${c}</span>`);const _=this._sugCountsForDevice(e).total;return _&&l.push(`<span class="wd-dbadge sug">\u{1F4A1} ${_}</span>`),e.feedback_count&&l.push(`<span class="wd-dbadge fb">\u{1F4AC} ${e.feedback_count}</span>`),`<button class="wd-devcard ${s===this._selIdx?"active":""}" data-idx="${s}">
        ...
        ${l.join("")}
      </button>`}).join("")}${t}</div>`}_htmlStatus(){const t=this._devices[this._selIdx];if(!t)return`<div class="wd-empty">${this._t("msg.no_device_selected",{},"No device selected.")}</div>`;const e=!!t.is_user_paused,s=e?"user_paused":t.detector_state||"unknown",r=!!t.recording,n=r?"var(--error-color, #f44336)":this._stateColor(s),a=r?this._t("status.recording",{},"Recording"):this._stateLabel(s),o=r||Rt.includes(s),i=t.cycle_progress_pct,l=t.time_remaining_s,c=t.current_program,_=!!t.manual_program,p=c?null:t.armed_program||null,f=c||p||"auto_detect",g=(this._profiles||[]).map(I=>I.name);c&&!g.includes(c)&&g.unshift(c),p&&!g.includes(p)&&g.unshift(p);const $=g.map(I=>`<option value="${d(I)}" ${f===I?"selected":""}>${d(I)}</option>`).join(""),k=c?_?this._t("badge.manual",{},"(manually selected)"):this._t("badge.auto",{},"(auto-detected)"):p?this._t("badge.armed",{},"(applies to the next cycle)"):"",b=k?`<span class="wd-prog-tag ${c?_?"manual":"auto":"manual"}">${k}</span>`:"",v=`<div class="wd-prog-ctl"><label>${this._t("lbl.program",{},"Program")}</label>${dt(this._t("lbl.program_tip",{},"Override which profile is matched to the current cycle. Auto-detect lets the integration pick the best match automatically. Pin a specific program to force-match it when auto-detect is wrong or you know what is running. Pick one before starting the appliance and it is applied as soon as the next cycle begins."))}
          <select id="wd-status-prog">
            <option value="auto_detect" ${f==="auto_detect"?"selected":""}>${this._t("status.auto_detect",{},"Auto-detect")}</option>
            ${$}
          </select>${b}</div>`,S=[];t.recording&&this._canEdit()&&S.push(`<div class="wd-attn-card"><span class="wd-attn-icon">\u25CF</span><div class="wd-attn-body"><div class="wd-attn-title">${this._t("msg.recording_in_progress",{},"Recording in progress")}</div><div class="wd-attn-sub">${this._t("msg.see_recorder",{},"See recorder widget below")}</div></div></div>`),t.feedback_count&&this._canEdit()&&S.push(`<button class="wd-attn-card" type="button" data-action="goto-feedbacks"><span class="wd-attn-icon">\u{1F4AC}</span><div class="wd-attn-body"><div class="wd-attn-title">${this._t("msg.feedback_cycles_pending",{n:t.feedback_count},`To review: ${t.feedback_count}`)}</div><div class="wd-attn-sub">${this._t("msg.review_to_cycles",{},"Open the Cycles review queue")}</div></div></button>`);const D=this._conflictKeysFromOpts();if(D.size&&this._canEdit()){const I=D.size,W=I>1?"s":"";S.push(`<button class="wd-attn-card" type="button" style="border-color:var(--error-color,#b71c1c)" data-action="goto-conflicts"><span class="wd-attn-icon">\u26A0</span><div class="wd-attn-body"><div class="wd-attn-title" style="color:var(--error-color,#b71c1c)">${this._t("conflict.attn_title",{n:I},`Setting conflicts: ${I}`)}</div><div class="wd-attn-sub">${this._t("conflict.attn_sub",{},"Fix conflicts before saving")}</div></div></button>`)}const z=this._sugCountsForDevice(t);if(z.total&&this._canEdit()){const I=z.total,W=[];z.classic&&W.push(this._t("lbl.n_classic_suggestions",{n:z.classic},`${z.classic} classic`)),z.ml&&W.push(this._t("lbl.n_ml_suggestions",{n:z.ml},`${z.ml} ML`)),S.push(`<button class="wd-attn-card" type="button" data-action="goto-suggestions"><span class="wd-attn-icon">\u{1F4A1}</span><div class="wd-attn-body"><div class="wd-attn-title">${this._t("lbl.n_tuning_suggestions",{n:I},`${I} tuning suggestion${I>1?"s":""}`)}</div><div class="wd-attn-sub">${W.join(" \xB7 ")} \xB7 ${this._t("msg.review_in_settings",{},"Review in Settings")}</div></div></button>`)}const O=S.length?`<div class="wd-attn">${S.join("")}</div>`:"",R=t.envelope_position,L=R!=null?Math.round(R*100):null,A=L!=null?` <span style="opacity:.75" title="${d(this._t("lbl.envelope_position_tip",{pct:L},`Position on the matched program's own recorded curve, ${L}%. Measured by aligning this cycle against the profile instead of counting time, so it stays right when a run is longer or shorter than usual. It refreshes while the appliance is quiet, so it can lag behind during an active phase.`))}">${this._t("lbl.envelope_position",{pct:L},`curve ${L}%`)}</span>`:"",C=o&&i!=null?`
      <div class="wd-prog-bg"><div class="wd-prog-fill" style="width:${Math.min(100,i)}%"></div></div>
      <div class="wd-prog-row"><span>${i.toFixed(1)}%${A}</span>${l!=null?`<span>${this._t("lbl.time_remaining",{v:_t(l)},`~${_t(l)} remaining`)}</span>`:""}</div>
    `:"",F=((this._powerData||{}).live||[]).length>1,U=this._pref("show_expected",!0),st=this._pref("show_raw_active",!1),tt=`<div class="wd-leg">
      <span class="wd-leg-i"><span class="wd-leg-sw" style="background:var(--primary-color)"></span> ${this._t("lbl.power",{},"Power")}</span>
      ${this._statusEnv?`<label class="wd-leg-i"><input type="checkbox" data-statustoggle="show_expected" ${U?"checked":""}><span class="wd-leg-sw" style="background:#ff9800"></span> ${this._t("lbl.expected",{},"Expected")}</label>`:""}
      ${this._pref("show_raw",!1)?`<label class="wd-leg-i"><input type="checkbox" data-statustoggle="show_raw_active" ${st?"checked":""}><span class="wd-leg-sw" style="background:#9e9e9e"></span> ${this._t("lbl.raw_socket",{},"Raw socket")}</label>`:""}
    </div>`,Y=this._cyclesTotal||0,Q=(this._profiles||[]).length,wt=this._pref("setup_card_dismissed",!1),X=this._setupStatus,lt=X&&!F,Z=lt?this._htmlSetupCard(X,wt):"",ot=F?`<div class="wd-canvas-wrap" style="margin-top:14px"><canvas id="wd-status-canvas" role="img" aria-label="${d(this._t("lbl.aria_power_chart",{},"Power consumption chart"))}" style="height:160px"></canvas></div>${tt}`:lt?Z:`<p class="wd-info" style="margin-top:12px">${this._t("msg.live_chart_loading",{},"Live power chart appears as readings arrive.")}</p>`,ht=this._pref("show_debug",!1);let pt="";if(ht){const I=this._matchDebug||{},W=I.confidence!=null?`${(I.confidence*100).toFixed(1)}%`:"-",H=(I.candidates||[]).map(N=>`<tr><td>${d(N.profile_name)}</td><td>${N.confidence_pct}%</td><td>${N.mae}</td><td>${N.correlation}</td><td>${N.duration_ratio>=0?"+":""}${N.duration_ratio}%</td></tr>`).join("");pt=`<div class="wd-card">
        <div class="wd-card-title">Live Match Debug ${dt("Confidence: how closely the current power curve matches the top candidate profile (0-100%). Ambiguous: the two best candidates score within 5% of each other - the label is uncertain until the cycle finishes.")}</div>
        <div class="wd-kv" style="margin-bottom:12px">
          ...
          <div class="wd-kv-item"><div class="wd-kv-val" style="font-size:1em;color:${I.ambiguous?"var(--warning-color,#ff9800)":"var(--success-color,#4caf50)"}">${I.ambiguous?this._t("status.ambiguous",{},"Ambiguous"):this._t("status.clear",{},"Clear")}</div><div class="wd-kv-lbl">${this._t("lbl.label",{},"Match")}</div></div>
        </div>
      ...
      </div>`}const y=[],m=t.standby_above_stop;m&&this._canEdit()&&S.push(`<button class="wd-attn-card" type="button" style="border-color:var(--warning-color,#ff9800)" data-action="goto-conflicts"><span class="wd-attn-icon">\u26A0</span><div class="wd-attn-body"><div class="wd-attn-title" style="color:var(--warning-color,#ff9800)">${this._t("msg.standby_above_stop_title",{idle:m.idle_w,stop:m.stop_threshold_w},`Still drawing ${m.idle_w} W when the cycle ended`)}</div><div class="wd-attn-sub">${this._t("msg.standby_above_stop_sub",{n:m.cycles_above,total:m.cycles_checked,stop:m.stop_threshold_w},`${m.cycles_above} of the last ${m.cycles_checked} cycles. The off delay only starts below the Stop Threshold (${m.stop_threshold_w} W), so cycles finish late.`)}</div></div></button>`),this._canEdit()&&y.push(`<button class="wd-attn-card" type="button" data-action="open-advanced" data-sub="diagnostics"><span class="wd-attn-icon">\u{1FA7A}</span><div class="wd-attn-body"><div class="wd-attn-title">${this._t("hdr.logs_diagnostics",{},"Diagnostics")}</div><div class="wd-attn-sub">${this._t("msg.storage_diagnostics",{},"Storage stats, maintenance, export/import")}</div></div></button>`),y.push(`<button class="wd-attn-card" type="button" data-action="open-settings"><span class="wd-attn-icon">\u2699\uFE0F</span><div class="wd-attn-body"><div class="wd-attn-title">${this._t("settings.gear.title",{},"Settings")}</div><div class="wd-attn-sub">${this._isAdmin()?this._t("msg.preferences_admin",{},"Preferences, panel & access control"):this._t("msg.preferences_adv",{},"Preferences")}</div></div></button>`);const u=`<div class="wd-card"><div class="wd-card-title">${this._t("hdr.tools_and_data",{},"Tools & Data")}</div><div class="wd-attn" style="margin-bottom:0;margin-top:12px">${y.join("")}</div></div>`,E=(()=>{if(!this._canEdit())return"";const I=Rt.includes(s),W=I&&!e,H=e,N=I||e;return!W&&!H&&!N?"":`<div class="wd-cycle-ctrl" style="margin-top:0">
      ...
      <div class="wd-card">
        ...
        ${lt?"":`<div class="wd-card-title" style="margin-top:18px">${this._t("hdr.live_power",{},"Live Power")}</div>`}
        ${ot}
      </div>
    ...
    `}_htmlSetupCard(t,e=!1){if(!t)return"";const{phase:s,message_key:r,message_params:n,cta_label_key:a,cta_action:o,secondary_label_key:i,secondary_action:l,skippable:c,dismissible:_,step_key:p}=t;if(s==="phase4")return`
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:8px;flex-wrap:wrap">
        ...
        <td class="wd-tc-num">${I!=null?I.toFixed(0)+"%":"-"}</td>
      </tr>`}).join(""),st=`<thead><tr>
      ...
      ${vt(this._t("lbl.cost",{},"Cost"),"cost",o==="cost",i,"cycsort","right",this._t("col.cost_tip",{},"Energy cost for this cycle, frozen at completion. With Time-Weighted Cost on, the power trace is charged at the price in force at each moment; otherwise energy x the single price in effect at the end. Set a price under Settings to populate it."))}
    ...
    </div>`,Y=b.length!==s.length?this._t("lbl.n_shown",{n:b.length},`, ${b.length} shown`):"",Q=e.length?this._t("lbl.n_imported_note",{n:e.length},`, ${e.length} imported`):"",wt=this._t("lbl.cycles_title",{n:`${t.length}${Q}${Y}`},`Cycles (${t.length}${Q}${Y})`),X=r?`<div class="wd-card-actions" style="margin:0 0 4px;justify-content:flex-end">
    ...
    </div>`:"",lt=new Set(e.map(u=>u.id)),Z=[...a].some(u=>lt.has(u)),ot=n?`<div class="wd-card-actions" style="margin:0 0 10px">
      ...
      <button class="wd-btn wd-btn-secondary wd-btn-sm" data-action="cyc-merge" ${a.size<2||Z?"disabled":""}${Z?` title="${d(this._t("msg.merge_no_imports",{},"Imported recordings cannot be merged into a real cycle. Deselect them to merge."))}"`:""}>${this._t("btn.merge",{},"Merge")}${a.size>=2?` (${a.size})`:""}</button>
    ...
    `}_htmlProfileGroupModal(t){const e=this._busy.has("pg-save"),s=this._profileEnvCache||{},r=p=>it[Math.max(0,this._profiles.findIndex(f=>f.name===p))%it.length],n=t.members||[],a=this._profiles.map(p=>{const f=n.includes(p.name),g=p.avg_duration?`~${Math.round(p.avg_duration/60)}m`:"",$=p.avg_energy!=null?` \xB7 ${yt(p.avg_energy)}`:"",k=f?`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${r(p.name)};margin:0 2px"></span>`:"";return`<label class="wd-rev-tag"><input type="checkbox" class="wd-pg-mem" value="${d(p.name)}" ${f?"checked":""}> ${k}${d(p.name)} <span style="color:var(--secondary-text-color);font-size:.85em">${g}${$}</span></label>`}).join(""),o=n.filter(p=>s[p]&&(s[p].avg||[]).length),i=o.length?`<div class="wd-leg">${o.map(p=>`<span class="wd-leg-i"><span class="wd-leg-sw" style="background:${r(p)}"></span> ${d(p)}</span>`).join("")}</div>`:"",l=o.length?`<div class="wd-canvas-wrap" style="margin-top:8px"><canvas id="wd-pgroup-canvas" role="img" aria-label="${d(this._t("lbl.aria_envelope_chart",{},"Profile power envelope chart"))}" style="height:150px"></canvas></div>${i}`:`<p class="wd-info">${this._t("msg.group_preview_hint",{},"Tick 2+ members to preview and compare their power curves.")}</p>`,c=((this._profileGroups||{}).groups||[]).find(p=>p.name===t.orig),_=c&&c.cohesion!=null?`<span class="wd-badge" style="color:${c.cohesive?"var(--success-color,#4caf50)":"var(--warning-color,#ff9800)"};background:${c.cohesive?"rgba(76,175,80,.14)":"rgba(255,152,0,.14)"}">${c.cohesive?this._t("lbl.cohesion_good",{pct:Math.round(c.cohesion*100)},"cohesion "+Math.round(c.cohesion*100)+"%"):this._t("lbl.cohesion_low",{pct:Math.round(c.cohesion*100)},"\u26A0 low cohesion "+Math.round(c.cohesion*100)+"%")}</span>`:"";return`<h2>${t.orig?this._t("modal.edit_group",{},"Edit profile group"):this._t("modal.new_group",{},"New profile group")}</h2>
      ...
      </div>`:"",D=this._suggestions.length,z=[...a].filter(X=>!n.has(X)).length,O=D+z,R=this._settingsSugOnly&&!this._settingsSearch,L=D?`<button class="wd-btn wd-btn-sm wd-btn-primary" data-action="sug-apply-all">${this._t("btn.apply_all",{},"Apply all")}</button>`:"",A=D?`<button class="wd-btn wd-btn-sm wd-btn-secondary" data-action="sug-dismiss">${this._t("btn.dismiss",{},"Dismiss")}</button>`:"",C=O?R?`
      ...
      <div class="wd-sug-banner">
        ...
        ${L}
        ${A}
      </div>`:"",P=this._busy.has("sug-analyze"),F=`<button class="wd-btn wd-btn-secondary wd-btn-sm" data-action="sug-analyze" ${P?"disabled":""} title="${d(this._t("btn.run_analysis_tip",{},"Analyze your recorded cycles now and refresh tuning suggestions"))}">${P?'<span class="wd-spin"></span> '+this._t("status.analyzing",{},"Analyzing\u2026"):this._t("btn.run_analysis",{},"\u{1F50D} Run suggestion analysis")}</button>`,U=this._settingsSearch||"",st=U.trim().toLowerCase(),tt=`<input type="text" id="wd-settings-search" class="wd-filter-input" placeholder="${this._t("msg.search_placeholder",{},"Search settings\u2026")}" value="${d(U)}" autocomplete="off" style="flex:0 0 auto;width:200px;max-width:40%">`,Y=st?this._htmlSettingsSearch(t,st):R?this._htmlSettingsSugOnly(t):this._htmlSettingsSection(t),Q=(this._lockedSuggestions||[]).length,wt=Q?`
      ...
      <div class="wd-card">
        <form id="wd-settings-form">${Y}</form>
    ...
    </div>`:"";return`<div class="wd-field"><label>${d(r)} ${n?dt(n):""}${c}${_}</label>
      <div class="wd-combo-row">
        <div class="wd-combo">
    ...
    `}_htmlMlStatusSection(t,e){const s=e&&this._busy.has("ml-train-now:"+e)||t&&t.running,r=this._canEdit()?`<button class="wd-btn wd-btn-primary wd-btn-sm" data-action="ml-train-now" ${s?"disabled":""}>${s?`<span class="wd-spin"></span> ${this._t("status.training",{},"Training\u2026")}`:this._t("btn.train_now",{},"Train now")}</button>`:"";if(!t)return`<div class="wd-card"><div class="wd-card-title" style="margin:0 0 4px">${this._t("hdr.status",{},"Status")}</div><p class="wd-info" style="margin:0">${this._t("msg.loading",{},"Loading\u2026")}</p></div>`;const n=Object.keys(t.on_device_models||{}).length,a=n?`<span style="color:var(--success-color,#4caf50);font-weight:600">${this._t("ml.personalized",{},"\u25CF Personalized to this machine")}</span> <span style="color:var(--secondary-text-color)">${this._t("lbl.models_fine_tuned",{count:n},"(fine-tuned models: "+n+")")}</span>`:`<span style="color:var(--secondary-text-color)">${this._t("ml.builtin_models",{},"\u25CF Using built-in models")}</span>`,o=t.cycle_count||0,i=t.min_cycles||0,l=o>=i,c=i>0?Math.min(100,Math.round(o/i*100)):100,_=l?"var(--success-color,#4caf50)":"var(--warning-color,#ff9800)",p=Math.max(0,i-o),f=l?this._t("msg.enough_data",{current:o,min:i},`Enough data to learn from (${o}/${i} cycles).`):this._t("msg.collecting_data",{need:p,current:o,min:i},`Collecting data. Cycles still needed before fine-tuning can start: ${p} (${o}/${i}).`),g=`<div style="height:8px;border-radius:6px;background:var(--secondary-background-color);overflow:hidden;margin:8px 0"><div style="width:${c}%;height:100%;background:${_}"></div></div>`,$=t.last_trained?rt(t.last_trained):"never",k=s?`<span style="color:var(--info-color,#2196f3)"><span class="wd-spin"></span> ${this._t("status.fine_tuning",{},"fine-tuning now\u2026")}</span>`:t.enabled?this._t("lbl.auto_fine_tune_on",{hour:String(t.hour).padStart(2,"0")},`auto fine-tune on (around ${String(t.hour).padStart(2,"0")}:00)`):this._t("lbl.auto_fine_tune_off",{},"auto fine-tune off");return`<div class="wd-card">
      ...
      ${r}
        ...
        </div>`,n=k);const C=this._pgStagedVal(p),P=C!=null&&!(v!==""&&v!==null&&v!==void 0&&this._pgSameVal(C,v)),F=this._canEdit()&&P&&this._pgIsPublishable(p)?`<button class="wd-pg-pub" data-action="pg-publish-one" data-pgkey="${d(p)}" aria-label="${d(this._t("btn.pg_publish_one",{label:b},"Publish "+b+" to the integration"))}" title="${d(this._t("btn.pg_publish_one",{label:b},"Publish "+b+" to the integration"))}">\u2191</button>`:'<span class="wd-pg-pub-slot" aria-hidden="true"></span>';return`${A}<div style="display:flex;align-items:flex-start;gap:6px;margin:0 0 6px 11px">
        <div style="flex:1;min-width:0">
    ...
    ${r||`<div class="wd-card"><p class="wd-info">${this._t("msg.no_other_users",{},"No other Home Assistant users found.")}</p></div>`}`}_htmlStore(){if(!this._canEdit())return`<div class="wd-empty">${this._t("msg.no_device_selected",{},"No device selected.")}</div>`;const t=this._storeStatus,e=`<a href="https://3dg1luk43.github.io/washdata-store" target="_blank" rel="noopener noreferrer" style="font-size:.8em;font-weight:400;color:var(--primary-color);text-decoration:none;white-space:nowrap" title="${d(this._t("store.website_tip",{},"Open the community store website"))}">${this._t("store.website",{},"Store website \u2197")}</a>`,s=`<div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap"><div class="wd-card-title" style="margin:0">${this._t("hdr.community_store",{},"Community Store")}</div>${e}</div>`;if(!this._onlineEnabled()||t&&t.enabled===!1)return`<div class="wd-card">${s}
      ...
      ${Ut(`data-action="store-toggle-dl-settings" ${this._dlSettings?"checked":""} ${n?"disabled":""}`,this._t("lbl.adopt_settings",{},"Also adopt settings"),dt(this._t("msg.adopt_settings_hint",{},"Overwrite this device's detection & matching thresholds with the shared ones. Your notifications, entities and energy price are never changed.")))}
      ...
      ${t?n:""}
    </div>`}_htmlStorePrefs(t){const e=this._constants&&this._constants.storePrefs||{},s=pe.map(n=>{const a=e[n.key]!==!1;return Mt(`data-action="store-toggle-pref" data-pref="${d(n.key)}" ${a?"checked":""} ${t?"disabled":""}`,this._t(n.labelKey,{},n.labelFb),dt(this._t(n.docKey,{},n.docFb)))}).join(""),r=this._busy.has("store-refresh-catalog");return s+`
      ...
      <div class="wd-log-drawer-body">
        ...
        ${dt(this._t("msg.include_settings_hint",{},"Share this device's recognition and matching thresholds (not your notifications, entities or energy price). Adopters choose whether to apply them."))}
      ...
      <span class="wd-sd-prof-name"><strong>${this._t("btn.select_all",{},"Select all")}</strong></span>
        ...
        <span class="wd-sd-count">${k}</span>
          ...
          <span class="wd-sd-cyc-meta">${d(v.name)} \xB7 ${(v.real_cycles||0)+(v.reference_cycles||0)} ${this._t("lbl.cycles_short",{},"cycles")}${n.has(v.name)?` <span class="wd-tag" style="color:var(--warning-color,#e6a700)">${this._t("badge.exists",{},"exists")}</span>`:""}</span>
        </label>`).join("")}</div>`;else if(!f&&(_==="real_cycles"||_==="reference_cycles")){const v=_==="real_cycles"?t.sel.realIds:t.sel.refIds;b=`<div class="wd-sd-cycles">${(p.groups||[]).map(S=>{const D=S.cycles.map(P=>String(P.id)),z=D.filter(P=>v.has(P)).length,O=z===D.length&&D.length>0,R=z>0&&!O,L=`${_}:${S.profile}`,A=t.expanded&&t.expanded.has(L),C=A?S.cycles.map(P=>`<label class="wd-sd-cyc" style="margin-left:18px">
            <input type="checkbox" data-maction="wiz-toggle-cyc" data-cat="${_}" data-cid="${d(String(P.id))}" ${v.has(String(P.id))?"checked":""}>
            <span class="wd-sd-cyc-meta">${d(P.date?rt(P.date):String(P.id))}${P.duration!=null?" \xB7 "+_t(P.duration):""}</span>
            ...
            <div class="wd-sd-cyc" style="display:flex;align-items:center">
              ...
              <button type="button" class="wd-linkbtn" data-maction="wiz-expand" data-key="${d(L)}" style="margin-left:auto;background:none;border:none;color:var(--primary-color);cursor:pointer">${A?"\u25BE":"\u25B8"}</button>
            </div>
            ${C}
      ...
      <div class="wd-modal-actions">
        ...
        <div class="wd-modal-actions"><button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button></div>`;const e=t.curve||{},s=!!e.is_reference,r=e.labelable!==!1,n=e.editable!==!1,a=e.cycle_origin==="backfill",o=e.full_duration_s||e.duration||0,i=e.energy_kwh!=null?e.energy_kwh:null,l=t.ml||null;let c="";if(l&&l.ml_quality_score!=null){const C=l.ml_quality_label,P=C==="ok"?"var(--success-color,#4caf50)":C==="uncertain"?"var(--warning-color,#ff9800)":"var(--error-color,#f44336)",F=Math.round((1-l.ml_quality_score)*100);c=`<div class="wd-kv-item"><div class="wd-kv-val" style="font-size:.95em;color:${P}">${F}%</div><div class="wd-kv-lbl">${this._t("lbl.cycle_health",{},"Cycle health")}</div></div>`}const _=`<div class="wd-kv">
      ...
      <button class="wd-btn wd-btn-sm ${t.mode==="review"?"wd-btn-primary":"wd-btn-secondary"}" data-maction="cyc-review" title="${$?this._t("hdr.automation_needs_review",{},"This cycle needs review"):this._t("hdr.automation_review_this_cycle",{},"Review this cycle")}">${this._t("btn.review",{},"Review")}${k}</button>
        ...
        <button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button>
        ${F}
        ${U}</div>`}else if(t.mode==="trim"){const C=this._busy.has("cyc-trim-apply"),P=t.timeMode||"s",F=P==="clock"?this._offsetToClock(t.trim.start):Math.round(t.trim.start),U=P==="clock"?this._offsetToClock(t.trim.end):Math.round(t.trim.end),st=P==="clock"?"time":"number",tt=P==="clock"?'step="1"':`min="0" max="${Math.ceil(o)}" step="1"`,Y=P==="clock"?"":" "+this._t("lbl.unit_s",{},"(s)");D=`<p class="wd-info" style="margin:4px 0 8px">${this._t("msg.trim_intro",{},"Drag the red handles, or enter values. Everything outside the window is removed.")}</p>
        <div class="wd-mode-bar" style="margin-bottom:8px;align-items:center">
          ...
          <button class="wd-btn wd-btn-sm ${P==="s"?"wd-btn-primary":"wd-btn-secondary"}" data-maction="trim-mode-s">${this._t("lbl.seconds_from_start",{},"Seconds from start")}</button>
          <button class="wd-btn wd-btn-sm ${P==="clock"?"wd-btn-primary":"wd-btn-secondary"}" data-maction="trim-mode-clock">${this._t("lbl.clock_time",{},"Clock time")}</button>
        </div>
        <div class="wd-form-grid">
          <div class="wd-field"><label>${this._t("lbl.start",{},"Start")}${Y}</label><input type="${st}" id="wd-trim-start" ${tt} value="${F}"></div>
          <div class="wd-field"><label>${this._t("lbl.end",{},"End")}${Y}</label><input type="${st}" id="wd-trim-end" ${tt} value="${U}"></div>
        </div>
        <div class="wd-modal-actions">
          <button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button>
        ...
        </div>`}else if(t.mode==="split"){const C=this._busy.has("cyc-split-apply"),P=(t.split.offsets||[]).slice().sort((st,tt)=>st-tt),F=[0,...P,o],U=F.slice(0,-1).map((st,tt)=>{const Y=F[tt+1];return`<div class="wd-seg-row"><span class="wd-swatch" style="background:${it[tt%it.length]}"></span>
          <span style="min-width:120px">${_t(st)} \u2013 ${_t(Y)}</span>
        ...
        <div style="margin:10px 0">${P.length?U:`<p class="wd-info">${this._t("msg.no_split_points",{},"No split points yet.")}</p>`}</div>
        <div class="wd-modal-actions">
          <button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button>
          <button class="wd-btn wd-btn-primary" data-maction="cyc-apply-split" ${C||!P.length?"disabled":""}>${C?'<span class="wd-spin"></span> '+this._t("status.splitting",{},"Splitting\u2026"):this._t("btn.apply_split",{},"Apply Split")}</button>
        </div>`}else if(t.mode==="review"){const C=l&&l.ml_review||{},P=this._busy.has("cyc-review-save"),F=(Z,ot)=>`<option value="${Z}" ${(C.quality||"")===Z?"selected":""}>${ot}</option>`,st=[["late_start",this._t("tag.late_start",{},"Late start")],["early_end",this._t("tag.early_end",{},"Early end")],["merged",this._t("tag.merged",{},"Merged cycles")],["split",this._t("tag.split",{},"Split cycle")],["noise",this._t("tag.noise",{},"Noise")],["wrong_profile",this._t("tag.wrong_profile",{},"Wrong profile")],["sensor_gap",this._t("tag.sensor_gap",{},"Sensor gap")]].map(([Z,ot])=>`<label class="wd-rev-tag"><input type="checkbox" class="wd-cyc-rev-tag" value="${Z}" ${(C.tags||[]).includes(Z)?"checked":""}> ${ot}</label>`).join(""),tt=C.reviewed_at?`<span style="font-size:.75em;color:var(--secondary-text-color)">${this._t("lbl.reviewed_on",{date:new Date(C.reviewed_at).toLocaleDateString()},`reviewed ${new Date(C.reviewed_at).toLocaleDateString()}`)}</span>`:"",Y=dt(this._t("msg.review_profile_tip",{},"The program this cycle is labelled as. If the auto-detected program was wrong, correct it here - labelling teaches matching for future cycles.")),Q=dt(this._t("msg.review_quality_tip",{},"How clean this cycle is. Good = a textbook example of this program; Bad = detected but noisy or atypical; Unusable = mis-detected (merged, truncated or spurious). Drives the health score and which cycles are allowed to train the model.")),wt=dt(this._t("msg.review_recorded_tip",{},'Mark this as a hand-picked reference cycle for its program - the same role as a manually recorded cycle. Reference cycles are always kept, seed the matching template, and are never dropped by cleanup. (This is the "golden"/recorded flag; both are the same thing.)')),X=dt(this._t("msg.review_tags_tip",{},"Optional flags describing what went wrong with this cycle, so training and cleanup can account for it.")),lt=dt(this._t("msg.review_notes_tip",{},"Free-text notes for your own reference. Not used by matching or training."));D=`
        ${S}
        ...
        <div style="display:flex;gap:16px;flex-wrap:wrap;align-items:center;margin:6px 0">
          <label style="display:inline-flex;align-items:center;gap:6px">${this._t("lbl.profile",{},"Profile")}${Y}
          ...
          <label style="display:inline-flex;align-items:center;gap:6px"><input type="checkbox" id="wd-cyc-rev-golden" ${C.golden?"checked":""}> ${this._t("badge.golden_cycle",{},"Recorded reference cycle")}${wt}</label>
          ${tt}
        </div>
        <div class="wd-rev-sub">${this._t("lbl.compare_profiles",{},"Compare with profiles")}${dt(this._t("msg.compare_profiles_tip",{},"Overlay other profile envelopes on the chart above to see which one best fits this cycle."))}</div>
        <div class="wd-rev-tags">${(this._profiles||[]).map(Z=>{const ot=(t.overlays||[]).includes(Z.name),ht=ot?`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${it[Math.max(0,this._profiles.findIndex(pt=>pt.name===Z.name))%it.length]};margin:0 2px"></span>`:"";return`<label class="wd-rev-tag"><input type="checkbox" class="wd-cyc-overlay" value="${d(Z.name)}" ${ot?"checked":""}> ${ht}${d(Z.name)}</label>`}).join("")||`<span class="wd-info">${this._t("msg.no_profiles_compare",{},"No profiles to compare.")}</span>`}</div>
        <div class="wd-rev-sub">${this._t("lbl.tags",{},"Tags")}${X}</div>
        <div class="wd-rev-tags">${st}</div>
        <div class="wd-rev-sub">${this._t("lbl.notes",{},"Notes")}${lt}</div>
        ...
        <div class="wd-modal-actions" style="margin-top:16px">
          <button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button>
          <button class="wd-btn wd-btn-primary" data-maction="cyc-review-save" ${P?"disabled":""}>${P?'<span class="wd-spin"></span> '+this._t("status.saving",{},"Saving\u2026"):this._t("btn.save_review",{},"Save Review")}</button>
        </div>`}let z="";const O=t.mode==="view"||t.mode==="review"?e.artifacts||[]:[];if(O.length){const C=O.map(P=>{const F=P.detail_key?this._t(P.detail_key,P.detail_params||{},P.detail||""):P.detail||"";return`<li><b>${d(ne(P.type,(U,st,tt)=>this._t(U,st,tt)))}</b> ${this._t("lbl.at",{},"at")} ${zt(P.start_s)}\u2013${zt(P.end_s)} \u2014 ${d(F)}</li>`}).join("");z=`<div class="wd-card" style="margin:10px 0 0;padding:10px 12px;border-left:3px solid var(--warning-color,#ff9800)">
      ...
      </div>`}let R="";const L=t.mode==="view"||t.mode==="review"?e.restart_gaps||[]:[];if(L.length){const C=L.map(P=>{const F=Math.round((P.gap_seconds||0)/60),U=F>=1?`${F}m`:`${Math.round(P.gap_seconds||0)}s`,st=P.match_confidence!=null?` \xB7 ${this._t("lbl.pct_match_confidence",{pct:Math.round(P.match_confidence*100)},`${Math.round(P.match_confidence*100)}% match confidence`)}`:"",tt=P.profile?` (${d(P.profile)})`:"";return`<li>${this._t("msg.restart_gap_item",{dur:U},`${U} gap`)}: ${this._t("lbl.ha_restarted",{},"HA restarted")}${tt}${st}</li>`}).join("");R=`<div class="wd-card" style="margin:10px 0 0;padding:10px 12px;border-left:3px solid var(--info-color,#2196f3)">
      ...
      </div>`}let A="";if(e.decimated){const C=(e.samples||[]).length,P=e.sample_count||C;A=`<div class="wd-info" style="margin:4px 0 0;font-size:.72em;color:var(--secondary-text-color)">${this._t("msg.samples_decimated",{shown:C,total:P},`Showing ${C} of ${P} samples (thinned for display; peaks kept). A wide gap here is thinning, not missing data.`)}</div>`}return`<h2>${this._t("lbl.cycle",{},"Cycle")} \xB7 ${d(rt(e.start_time))}</h2>
      ${_}${x}
