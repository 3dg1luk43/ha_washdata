...
`));w=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.both_agree",{},"WashData recommends"))}</span><span class="wd-sug-val">${d(p)}${n}</span>${x(p)}${F}</div>`}else{const D=$?ct($):"",F=k?ct(k):"",B=g("suggestion.observed_label",{},"Observed"),R=g("suggestion.calibrated_label",{},"Calibrated");let P="",A="";if(!isNaN(v)&&!isNaN(T)){const G=T>v;A=g(`suggestion.impact.${s}.${G?"higher":"lower"}`,{},""),P=g(`suggestion.impact.${s}.${G?"lower":"higher"}`,{},"")}const M=P?`<div class="wd-sug-impact-line">${d(P)}</div>`:"",O=A?`<div class="wd-sug-impact-line">${d(A)}</div>`:"";w=`<div class="wd-sug wd-sug-split"><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(B)}</span><span class="wd-sug-val">${d(p)}${n}</span>${x(p)}${D}${M}</div><div class="wd-sug-opt"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(R)}</span><span class="wd-sug-val">${d(u)}${n}</span>${x(u)}${F}${O}</div></div>`}}else if(p!=null){const v=$?ct($):"",T=t!=null&&t!==""?` <span style="opacity:.6;font-size:.9em">(now ${d(t)}${n})</span>`:"";w=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-obs">\u{1F4A1} ${d(g("suggestion.observed_label",{},"Observed"))}</span><span class="wd-sug-val">${d(p)}${n}</span>${T}${x(p)}${v}</div>`}else if(u!=null){const v=k?ct(k):"";w=`<div class="wd-sug"><span class="wd-sug-chip wd-sug-chip-cal">\u{1F916} ${d(g("suggestion.calibrated_label",{},"Calibrated"))}</span><span class="wd-sug-val">${d(u)}${n}</span>${x(u)}${v}</div>`}if(w&&s){const v=d(g("btn.mute_suggestion",{},"Stop suggesting this setting")),T=`<button type="button" class="wd-sug-lock" data-suglock="${s}" title="${v}" aria-label="${v}">\u{1F515}</button>`;w=w.replace(/<\/div>\s*$/,T+"</div>")}return`<div class="wd-field" data-field="${s}"><div class="wd-label-row"><label style="margin:0">${d(r)}</label>${o}${a}</div>${i}${h.hint?`<div class="wd-field-hint">${d(h.hint)}</div>`:""}<div class="wd-conflict-err" data-cerr="${s}" hidden></div><div class="wd-setting-note" data-cnote="${s}" hidden></div>${w}</div>`}function Vt(h,t){if(h==null||t==null)return!1;const e=parseFloat(h),s=parseFloat(t);return!isNaN(e)&&!isNaN(s)?Math.abs(e-s)<1e-6:String(h)===String(t)}const Te={min_power:"min_power",off_delay:"off_delay",smoothing_window:"smoothing",start_threshold_w:"hysteresis",stop_threshold_w:"hysteresis",start_energy_threshold:"start_energy",running_dead_zone:"dead_zone",profile_duration_tolerance:"duration_tolerance",profile_match_min_duration_ratio:"match_ratios",profile_match_max_duration_ratio:"match_ratios",progress_reset_delay:"progress_reset",completion_min_seconds:"min_duration",min_off_gap:"min_off_gap",start_duration_threshold:"start_duration",end_energy_threshold:"end_energy_thresh",end_repeat_count:"end_repeat",profile_match_threshold:"confidence",profile_unmatch_threshold:"confidence",auto_label_confidence:"confidence",learning_confidence:"confidence",no_update_active_timeout:"watchdog_timeout",anti_wrinkle_enabled:"anti_wrinkle",anti_wrinkle_max_power:"anti_wrinkle",anti_wrinkle_max_duration:"anti_wrinkle",anti_wrinkle_exit_power:"anti_wrinkle",anti_wrinkle_idle_timeout:"anti_wrinkle",anti_crease_finalize_ratio:"anti_wrinkle",sampling_interval:"sampling"};function de(h){let t=0,e=window.innerWidth,s=0,r=window.innerHeight;for(let n=h.parentElement;n;n=n.parentElement){const a=getComputedStyle(n),o=a.overflowX!=="visible",i=a.overflowY!=="visible";if(!o&&!i)continue;const l=n.getBoundingClientRect();o&&(l.left>t&&(t=l.left),l.right<e&&(e=l.right)),i&&(l.top>s&&(s=l.top),l.bottom<r&&(r=l.bottom))}return{left:t,right:e,top:s,bottom:r}}function ct(h,t){return`<span class="wd-tip">i<span class="wd-tip-pop">${t?Ee(t):""}<span class="wd-tip-txt">${d(h)}</span></span></span>`}function Ut(h,t,e=""){return`<label class="wd-switch-lbl"><span class="wd-switch"><input type="checkbox" ${h}><span class="wd-switch-slider"></span></span><span class="wd-switch-text wd-switch-text--plain">${d(t)}</span></label>${e||""}`}function Mt(h,t,e="",s=""){return`<div class="wd-field wd-field-switch"><div class="wd-switch-row">${Ut(h,t,e)}</div>${s?`<div class="wd-field-hint">${d(s)}</div>`:""}</div>`}function Ee(h){const t=s=>`<svg class="wd-dg" viewBox="0 0 200 90" preserveAspectRatio="xMidYMid meet">${s}</svg>`,e='<line class="ax" x1="8" y1="78" x2="192" y2="78"/>';switch(h){case"smoothing":return t(`${e}
    ...
    `}_htmlSetupCard(t,e=!1){if(!t)return"";const{phase:s,message_key:r,message_params:n,cta_label_key:a,cta_action:o,secondary_label_key:i,secondary_action:l,skippable:c,dismissible:_,step_key:p}=t;if(s==="phase4")return`
        ...
        </div>`;const u=this._t(r,n||{},""),g=this._t(a,{},"Continue"),$=i?this._t(i,{},""):null,k=c?`
    ...
    </label>`,k=r?`<p class="wd-info" style="margin:0 0 10px;font-size:.82em">${this._t("msg.settings_basic_note",{},"Showing essential settings. Switch to Advanced for the full list.")}</p>`:"",x=this._busy.has("save-settings"),w=l.size,v=w!==1?"s":"",T=w?`
    ...
    </div>`:"";return`<div class="wd-field"><label>${d(r)} ${n?ct(n):""}${c}${_}</label>
      <div class="wd-combo-row">
        <div class="wd-combo">
    ...
    `}_htmlMlStatusSection(t,e){const s=e&&this._busy.has("ml-train-now:"+e)||t&&t.running,r=this._canEdit()?`<button class="wd-btn wd-btn-primary wd-btn-sm" data-action="ml-train-now" ${s?"disabled":""}>${s?`<span class="wd-spin"></span> ${this._t("status.training",{},"Training\u2026")}`:this._t("btn.train_now",{},"Train now")}</button>`:"";if(!t)return`<div class="wd-card"><div class="wd-card-title" style="margin:0 0 4px">${this._t("hdr.status",{},"Status")}</div><p class="wd-info" style="margin:0">${this._t("msg.loading",{},"Loading\u2026")}</p></div>`;const n=Object.keys(t.on_device_models||{}).length,a=n?`<span style="color:var(--success-color,#4caf50);font-weight:600">${this._t("ml.personalized",{},"\u25CF Personalized to this machine")}</span> <span style="color:var(--secondary-text-color)">${this._t("lbl.models_fine_tuned",{count:n},"(fine-tuned models: "+n+")")}</span>`:`<span style="color:var(--secondary-text-color)">${this._t("ml.builtin_models",{},"\u25CF Using built-in models")}</span>`,o=t.cycle_count||0,i=t.min_cycles||0,l=o>=i,c=i>0?Math.min(100,Math.round(o/i*100)):100,_=l?"var(--success-color,#4caf50)":"var(--warning-color,#ff9800)",p=Math.max(0,i-o),u=l?this._t("msg.enough_data",{current:o,min:i},`Enough data to learn from (${o}/${i} cycles).`):this._t("msg.collecting_data",{need:p,current:o,min:i},`Collecting data. Cycles still needed before fine-tuning can start: ${p} (${o}/${i}).`),g=`<div style="height:8px;border-radius:6px;background:var(--secondary-background-color);overflow:hidden;margin:8px 0"><div style="width:${c}%;height:100%;background:${_}"></div></div>`,$=t.last_trained?rt(t.last_trained):"never",k=s?`<span style="color:var(--info-color,#2196f3)"><span class="wd-spin"></span> ${this._t("status.fine_tuning",{},"fine-tuning now\u2026")}</span>`:t.enabled?this._t("lbl.auto_fine_tune_on",{hour:String(t.hour).padStart(2,"0")},`auto fine-tune on (around ${String(t.hour).padStart(2,"0")}:00)`):this._t("lbl.auto_fine_tune_off",{},"auto fine-tune off");return`<div class="wd-card">
      ...
      ${r}
        ...
        <div style="display:flex;align-items:center;gap:4px;flex-shrink:0">
          ${I?`<input class="wd-pg-param-chk" type="checkbox" data-pgkey="${d(p)}" data-pgtype="bool" aria-label="${d(w)}" ${T?"checked":""} style="width:18px;height:18px;margin:1px 27px 0 27px">`:`<input class="wd-pg-param-inp" type="text" inputmode="decimal" data-pgkey="${d(p)}" value="${T!==""?d(String(T)):""}" placeholder="${v!==""?d(String(v)):""}" aria-label="${d(w)}" style="width:72px">`}
    ...
    </tr></thead><tbody>${p}</tbody></table>`;return`${a}${r}${this._htmlPgRecentRuns("pg_history")}${o}${l}${u}`}_htmlPgBatchBar(){const t=this._pgBatchProgress;return t?`<div class="wd-pg-batchrow">
    ...
    </div>`}_htmlPgAnalysis(){const t=this._pgDtwData,e=(i,l,c,_,p)=>{const u=c&&l!=null?Math.max(0,Math.min(1,l/c)):l!=null?Math.max(0,Math.min(1,l)):0;return`<div class="wd-pg-score-bar-row">
        <span class="wd-pg-score-bar-lbl">${d(i)}</span>
        <div class="wd-pg-score-bar-track"><div class="wd-pg-score-bar-fill" style="width:${Math.round(u*100)}%;background:${_}"></div></div>
        <span class="wd-pg-score-bar-val">${p!=null?d(String(p)):"\u2014"}</span>
      </div>`};let s="";if(t&&(t.stage2||t.stage4)){const i=t.stage2||{},l=t.stage4||{},c=t.dtw||{},_=l.final_score??c.blended_score??i.score,p=this._pgDetail&&this._pgDetail.outcome&&this._pgDetail.outcome.confidence,u=p??_;let g="\u2014",$="var(--secondary-text-color)";u!=null&&(u>=.7?(g="\u2705 "+this._t("lbl.pg_strong_match",{},"Strong match"),$="var(--success-color, #4caf50)"):u>=.4?(g="\u26A0 "+this._t("lbl.pg_weak_match",{},"Weak match"),$="var(--warning-color, #ff9800)"):(g="\u274C "+this._t("lbl.pg_poor_match",{},"Poor match"),$="var(--error-color, #f44336)"));const k=t.profile_name||this._pgProfileName||"\u2014";s+=`<div style="font-weight:700;font-size:.9em;color:${$};margin-bottom:8px">${g}</div>`,k!=="\u2014"&&(s+=`<div style="font-size:.82em;color:var(--secondary-text-color);margin-bottom:6px">${d(k)} \xB7 ${d(this._t("lbl.score",{},"score"))} ${_!=null?_.toFixed(3):"\u2014"}</div>`),s+=e(this._t("lbl.correlation",{},"Correlation"),i.correlation,1,"#42a5f5",i.correlation!=null?i.correlation.toFixed(2):null),c.blended_score!=null&&(s+=e(this._t("lbl.pg_dtw",{},"DTW"),c.blended_score,1,"#ab47bc",c.blended_score.toFixed(2))),l.duration_agreement!=null&&(s+=e(this._t("lbl.duration",{},"Duration"),l.duration_agreement,1,"#66bb6a",l.duration_agreement.toFixed(2))),l.energy_agreement!=null&&(s+=e(this._t("lbl.energy",{},"Energy"),l.energy_agreement,1,"#ffa726",l.energy_agreement.toFixed(2))),s+='<div style="height:1px;background:var(--divider-color,rgba(127,127,127,.2));margin:8px 0"></div>'}else t||(s+=`<p class="wd-info" style="margin:0 0 8px">${this._t("msg.pg_analysis_empty2",{},"Press Run to see match analysis.")}</p>`);const r=this._pgDetail&&this._pgDetail.outcome,n=r&&r.matched_profile||t&&t.profile_name||this._pgProfileName||(this._cycles||[]).find(i=>i.id===this._pgCycleId)?.profile_name||"",a=r&&r.confidence;if(n&&a!=null){const i=Math.round(Math.max(0,Math.min(1,a))*100);s+=`<div class="wd-subhead" style="margin:0 0 4px">${d(this._t("lbl.pg_match_confidence",{},"Match confidence"))}</div>`,s+=`<div class="wd-pg-cand-row">
      ...
      </div>`})():"",_=new Date().toISOString().slice(0,10),p=s.map(v=>`<option value="${d(v)}">${d(this._maintLabel(v))}</option>`).join(""),u=t?`<div class="wd-card">
    ...
    </div>`:"",k=s.map(v=>{const T=parseInt(a[v],10)||0;if(T<=0)return"";const I=Math.max(0,parseInt(o[v],10)||0),D=Math.max(0,Math.min(100,Math.round(I/T*100))),B=I>=T?"var(--warning-color,#ff9800)":"var(--primary-color)";return`<div style="margin-top:10px">
    ...
    ${r||`<div class="wd-card"><p class="wd-info">${this._t("msg.no_other_users",{},"No other Home Assistant users found.")}</p></div>`}`}_htmlStore(){if(!this._canEdit())return`<div class="wd-empty">${this._t("msg.no_device_selected",{},"No device selected.")}</div>`;const t=this._storeStatus,e=`<a href="https://3dg1luk43.github.io/washdata-store" target="_blank" rel="noopener noreferrer" style="font-size:.8em;font-weight:400;color:var(--primary-color);text-decoration:none;white-space:nowrap" title="${d(this._t("store.website_tip",{},"Open the community store website"))}">${this._t("store.website",{},"Store website \u2197")}</a>`,s=`<div style="display:flex;justify-content:space-between;align-items:center;gap:12px;flex-wrap:wrap"><div class="wd-card-title" style="margin:0">${this._t("hdr.community_store",{},"Community Store")}</div>${e}</div>`;if(!this._onlineEnabled()||t&&t.enabled===!1)return`<div class="wd-card">${s}
      ...
      ${Ut(`data-action="store-toggle-dl-settings" ${this._dlSettings?"checked":""} ${n?"disabled":""}`,this._t("lbl.adopt_settings",{},"Also adopt settings"),ct(this._t("msg.adopt_settings_hint",{},"Overwrite this device's detection & matching thresholds with the shared ones. Your notifications, entities and energy price are never changed.")))}
      ...
      ${t?n:""}
    </div>`}_htmlStorePrefs(t){const e=this._constants&&this._constants.storePrefs||{},s=pe.map(n=>{const a=e[n.key]!==!1;return Mt(`data-action="store-toggle-pref" data-pref="${d(n.key)}" ${a?"checked":""} ${t?"disabled":""}`,this._t(n.labelKey,{},n.labelFb),ct(this._t(n.docKey,{},n.docFb)))}).join(""),r=this._busy.has("store-refresh-catalog");return s+`
      ...
      <div class="wd-log-drawer-body">
        ...
        <button class="wd-btn wd-btn-primary" data-maction="store-share-ok" ${this._busy.has("store-share")?"disabled":""}>${this._busy.has("store-share")?'<span class="wd-spin"></span> ':""}${this._t("btn.share",{},"Share")}</button></div>`}else t.type==="store-share-device"&&(e=this._htmlShareDeviceModal(t));return`<div class="wd-overlay"><div class="wd-modal" role="dialog" aria-modal="true" aria-labelledby="wd-modal-title" tabindex="-1">${e}</div></div>`}_htmlShareDeviceModal(t){const e=this._shareableByProgram(),s=this._busy.has("store-share-device"),r=t.selected||new Set,n=!!t.consented,a=e.reduce((g,$)=>g+$.cycles.filter(k=>r.has(k.id)).length,0),o=e.some(g=>!g.noCycles);let i;t.loading?i=`<div class="wd-empty" style="padding:24px"><div class="wd-icon">\u23F3</div>${this._t("msg.loading",{},"Loading\u2026")}</div>`:e.length?i=e.map(g=>{if(g.noCycles)return`<div class="wd-sd-group wd-sd-group-nocyc">
          ...
          </div>`;const $=g.cycles.every(T=>r.has(T.id)),k=!$&&g.cycles.some(T=>r.has(T.id)),x=g.cycles.map(T=>{const I=T.start_time?rt(T.start_time):"",D=T.duration!=null?_t(T.duration):"";return`<label class="wd-sd-cyc">
      ...
      <span class="wd-sd-prof-name"><strong>${this._t("btn.select_all",{},"Select all")}</strong></span>
    </label>`,c=a.map(_=>{const p=r[_],u=s.importableOnly&&p.importable===!1,g=this._wizCatState(t,_,e),k=["profiles","real_cycles","reference_cycles"].includes(_)?`${g.sel}/${p.count}`:"",x=`<label class="wd-sd-prof">
        <input type="checkbox" data-maction="wiz-toggle-cat" data-cat="${_}" ${g.state==="all"?"checked":""} ${g.state==="some"?'data-indeterminate="1"':""} ${u?"disabled":""}>
        <span class="wd-sd-prof-name">${d(this._wizCatLabel(_))}${u?` <span class="wd-tag">${this._t("badge.not_importable",{},"n/a here")}</span>`:""}</span>
        <span class="wd-sd-count">${k}</span>
      </label>`;let w="";if(!u&&_==="profiles")w=`<div class="wd-sd-cycles">${(p.items||[]).map(v=>`<label class="wd-sd-cyc">
          ...
          <span class="wd-sd-cyc-meta">${d(v.name)} \xB7 ${(v.real_cycles||0)+(v.reference_cycles||0)} ${this._t("lbl.cycles_short",{},"cycles")}${n.has(v.name)?` <span class="wd-tag" style="color:var(--warning-color,#e6a700)">${this._t("badge.exists",{},"exists")}</span>`:""}</span>
        </label>`).join("")}</div>`;else if(!u&&(_==="real_cycles"||_==="reference_cycles")){const v=_==="real_cycles"?t.sel.realIds:t.sel.refIds;w=`<div class="wd-sd-cycles">${(p.groups||[]).map(T=>{const I=T.cycles.map(M=>String(M.id)),D=I.filter(M=>v.has(M)).length,F=D===I.length&&I.length>0,B=D>0&&!F,R=`${_}:${T.profile}`,P=t.expanded&&t.expanded.has(R),A=P?T.cycles.map(M=>`<label class="wd-sd-cyc" style="margin-left:18px">
            ...
            <div class="wd-sd-cyc" style="display:flex;align-items:center">
              <label style="flex:1;display:flex;align-items:center;gap:8px;cursor:pointer">
                <input type="checkbox" data-maction="wiz-toggle-cycgroup" data-cat="${_}" data-prof="${d(T.profile)}" ${F?"checked":""} ${B?'data-indeterminate="1"':""}>
    ...
    </div>`;let u="";const $=(r.categories&&r.categories.profiles&&r.categories.profiles.items||[]).filter(x=>x.conflict&&t.sel.profiles.has(x.name));t.mode==="merge"&&$.length&&(u=`<div class="wd-field"><label>${this._t("lbl.conflict_resolution",{},"Name clashes")}</label>
      ...
      <div class="wd-modal-actions">
        ...
        <div class="wd-field">
          ...
          <div style="display:flex;gap:8px;align-items:center;flex-wrap:wrap">
            ...
            <input type="date" id="wd-hist-since" value="${d(t.since||jt())}" min="${d(xe())}" max="${d(ve())}" ${w}>
        ...
        </div>`;const $=n.map(x=>{const w=i.has(x.index),v=this._histSegReason(x.reason);return`<tr data-hist-row="${x.index}" style="${w?"":"opacity:.55"}">
      ...
      <div class="wd-modal-actions">
        ...
        <div class="wd-modal-actions"><button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button></div>`;const e=t.curve||{},s=!!e.is_reference,r=e.labelable!==!1,n=e.editable!==!1,a=e.cycle_origin==="backfill",o=e.full_duration_s||e.duration||0,i=e.energy_kwh!=null?e.energy_kwh:null,l=t.ml||null;let c="";if(l&&l.ml_quality_score!=null){const A=l.ml_quality_label,M=A==="ok"?"var(--success-color,#4caf50)":A==="uncertain"?"var(--warning-color,#ff9800)":"var(--error-color,#f44336)",O=Math.round((1-l.ml_quality_score)*100);c=`<div class="wd-kv-item"><div class="wd-kv-val" style="font-size:.95em;color:${M}">${O}%</div><div class="wd-kv-lbl">${this._t("lbl.cycle_health",{},"Cycle health")}</div></div>`}const _=`<div class="wd-kv">
      ...
      ${c}
    </div>`,p=l&&l.ml_review||{},u=(this._feedbacks||[]).some(A=>A.cycle_id===t.cycleId),g=l&&l.ml_quality_label,$=!p.reviewed_at&&(u||["uncertain","review"].includes(g)||["force_stopped","interrupted"].includes(e.status)),k=$&&t.mode!=="review"?` <span title="${this._t("hdr.automation_needs_review",{},"This cycle needs review")}" style="color:var(--warning-color,#ff9800);font-size:1.1em;line-height:0">\u25CF</span>`:"",x=this._canEdit()&&n?`<div class="wd-mode-bar">
      ...
      <button class="wd-btn wd-btn-sm ${t.mode==="review"?"wd-btn-primary":"wd-btn-secondary"}" data-maction="cyc-review" title="${$?this._t("hdr.automation_needs_review",{},"This cycle needs review"):this._t("hdr.automation_review_this_cycle",{},"Review this cycle")}">${this._t("btn.review",{},"Review")}${k}</button>
        ...
        </div>`}let D="";const F=t.mode==="view"||t.mode==="review"?e.artifacts||[]:[];if(F.length){const A=F.map(M=>{const O=M.detail_key?this._t(M.detail_key,M.detail_params||{},M.detail||""):M.detail||"";return`<li><b>${d(ne(M.type,(G,et,st)=>this._t(G,et,st)))}</b> ${this._t("lbl.at",{},"at")} ${zt(M.start_s)}\u2013${zt(M.end_s)} \u2014 ${d(O)}</li>`}).join("");D=`<div class="wd-card" style="margin:10px 0 0;padding:10px 12px;border-left:3px solid var(--warning-color,#ff9800)">
      ...
      ${I}`}_htmlProfilePanel(t){const e=this._canEdit();t.tab==="danger"&&!e&&(t.tab="stats");const s=[["stats",this._t("tab.pp_overview",{},"Overview")],["phases",this._t("tab.pp_phases",{},"Phases")],["cleanup",this._t("tab.pp_cleanup",{},"Cleanup")]];e&&s.push(["danger",this._t("tab.pp_manage",{},"Manage")]);const r=s.map(([o,i])=>`<button class="wd-mini-tab ${t.tab===o?"active":""}" data-maction="pp-tab-${o}">${i}</button>`).join("");let n="";if(!t.loaded)n=`<div class="wd-empty" style="padding:32px"><div class="wd-icon">\u23F3</div>${this._t("msg.loading",{},"Loading\u2026")}</div>`;else if(t.tab==="stats"){const o=t.stats||{},i=t.env||{},l=this._hass&&this._hass.config&&this._hass.config.currency||"",c=o.avg_energy!=null&&o.cycle_count?o.avg_energy*o.cycle_count:null,_=k=>k?Math.round(k/60)+"m":"-",p=(this._profileHealth||{})[t.name],u=(this._profileTrends||{})[t.name],g=p&&p.health_status!=="unknown"?(()=>{const k={healthy:["var(--success-color,#4caf50)","rgba(76,175,80,.12)"],fair:["var(--warning-color,#ff9800)","rgba(255,152,0,.12)"],poor:["var(--error-color,#f44336)","rgba(244,67,54,.12)"]},[x,w]=k[p.health_status]||k.fair,v=Math.round((p.health_score||0)*100),T=p.duration_cv!=null?` \xB7 ${this._t("stat.duration_cv",{pct:Math.round(p.duration_cv*100)},`duration CV ${Math.round(p.duration_cv*100)}%`)}`:"",I=p.confidence_mean!=null?` \xB7 ${this._t("stat.avg_confidence",{pct:Math.round(p.confidence_mean*100)},`avg confidence ${Math.round(p.confidence_mean*100)}%`)}`:"";return`<div style="margin:8px 0 4px;padding:8px 12px;border-radius:6px;background:${w};border:1px solid color-mix(in srgb, ${x} 13%, transparent);display:flex;align-items:center;gap:8px;flex-wrap:wrap">
        ...
        ${i.avg&&i.avg.length?`<div class="wd-canvas-wrap"><canvas id="wd-env-canvas" role="img" aria-label="${d(this._t("lbl.aria_envelope_chart",{},"Profile power envelope chart"))}"></canvas></div>`:`<p class="wd-info">${this._t("msg.no_envelope",{},"No envelope yet - rebuild after labelling cycles.")}</p>`}`}else if(t.tab==="phases"){const o=t.catalog||[],i=(t.phases||[]).map((c,_)=>{const p=o.map(u=>`<option value="${d(u)}" ${c.name===u?"selected":""}>${d(u)}</option>`).join("");return`<div class="wd-phase-row"><span class="wd-swatch" style="background:${it[_%it.length]}"></span>
        ...
        </div>`:""}`}else if(t.tab==="cleanup"){const o=t.cleanup&&t.cleanup.cycles||[],i=t.cleanup&&t.cleanup.selected||new Set,{col:l,dir:c}=this._cleanupSort,_={date:w=>w.start_time?new Date(w.start_time).getTime():0,duration:w=>w.duration,energy:w=>w.energy_kwh,status:w=>w.status||""},u=ae(o,_[l]||_.date,c).map((w,v)=>{const T=o.indexOf(w),I=e?`<td style="padding:4px 6px 4px 2px;white-space:nowrap">
      ...
      <div class="wd-modal-actions" style="margin-top:14px">
        <button class="wd-btn wd-btn-secondary" data-maction="cancel">${this._t("btn.close",{},"Close")}</button>
        ${a}
      </div>`}_drawCycleEditor(){const t=this._modal;if(!t||t.type!=="cycle-detail"||!t.loaded)return;const e=t.curve||{},s=e.samples||[];if(!s.length)return;let r=e.full_duration_s||s[s.length-1][0]||1;const n=[],a=t.profileEnv;if((t.mode==="view"||t.mode==="review")&&a&&(a.avg||[]).length&&(n.push({points:a.avg,stroke:"#ff9800",width:2,alpha:.45,name:`${this._t("lbl.expected",{},"Expected")} (${e.profile_name||"profile"})`}),r=Math.max(r,a.target_duration||a.avg[a.avg.length-1][0]||0)),t.mode==="review"&&(t.overlays||[]).length){const c=this._profileEnvCache||{};(t.overlays||[]).forEach(_=>{const p=c[_];if(!p||!(p.avg||[]).length)return;const u=it[Math.max(0,(this._profiles||[]).findIndex($=>$.name===_))%it.length];n.push({points:p.avg,stroke:u,width:1.6,alpha:.7,name:_});const g=p.avg[p.avg.length-1];r=Math.max(r,p.target_duration||(g?g[0]:0))})}n.push({points:s,stroke:"primary",fill:!0,width:2,name:this._t("lbl.power",{},"Power")});const o=[],i=[];let l=[];if(t.mode==="trim"){const c=t.trim.start,_=t.trim.end;o.push({x0:0,x1:c,fill:"rgba(244,67,54,.18)"}),o.push({x0:_,x1:r,fill:"rgba(244,67,54,.18)"}),i.push({x:c,color:"#f44336",label:"S"},{x:_,color:"#f44336",label:"E"})}else if(t.mode==="split")(t.split.offsets||[]).slice().sort((c,_)=>c-_).forEach((c,_)=>i.push({x:c,color:"#ff9800",label:"#"+(_+1)}));else{l=e.artifacts||[];const c={pause:"rgba(255,152,0,.22)",dip:"rgba(33,150,243,.18)",spike:"rgba(244,67,54,.18)"};l.forEach(p=>o.push({x0:p.start_s,x1:Math.max(p.end_s,p.start_s+1),fill:c[p.type]||"rgba(158,158,158,.18)"}));const _=e.start_time;(e.restart_gaps||[]).forEach(p=>{if(!_)return;const u=new Date(_).getTime(),g=Math.max(0,(new Date(p.start_ts).getTime()-u)/1e3),$=Math.max(g+1,(new Date(p.end_ts).getTime()-u)/1e3);o.push({x0:g,x1:$,fill:"rgba(96,125,139,.20)",label:"\u21BB"})})}this._drawCurves("wd-cyc-canvas",{series:n,xMax:r,bands:o,vlines:i,artifacts:l})}_htmlCompareModal(t){const e=t.ids||[],s={};(this._cycles||[]).forEach(o=>{s[o.id]=o});const r=t.hidden||new Set,n=e.map((o,i)=>{const l=s[o]||{},c=it[i%it.length],_=!r.has(o),p=!!(t.cycles&&t.cycles[o]),u=`${rt(l.start_time)||String(o).slice(0,8)} \xB7 ${Math.round((l.duration||0)/60)}m \xB7 ${d(l.profile_name||this._t("lbl.unlabelled",{},"Unlabelled"))}`;return`<label class="wd-rev-tag"><input type="checkbox" class="wd-compare-cyc" value="${d(o)}" ${_?"checked":""} ${p?"":"disabled"}><span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${c};margin:0 2px"></span>${u}${p?"":` <span class="wd-info">${this._t("lbl.loading_paren",{},"(loading\u2026)")}</span>`}</label>`}).join(""),a=(this._profiles||[]).map(o=>{const i=(t.overlays||[]).includes(o.name),l=it[Math.max(0,(this._profiles||[]).findIndex(_=>_.name===o.name))%it.length],c=i?`<span style="display:inline-block;width:10px;height:10px;border-radius:2px;background:${l};margin:0 2px;opacity:.55"></span>`:"";return`<label class="wd-rev-tag"><input type="checkbox" class="wd-compare-overlay" value="${d(o.name)}" ${i?"checked":""}> ${c}${d(o.name)}</label>`}).join("")||`<span class="wd-info">${this._t("msg.no_profiles_overlay",{},"No profiles to overlay.")}</span>`;return`<h2>${this._t("msg.compare_cycles_title",{count:e.length},`Compare ${e.length} cycles`)}</h2>
